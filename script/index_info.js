...
if(window.friendalbum){ 
    document.write('<SCRIPT TYPE="text/javascript" LANGUAGE="javascript" SRC="https://ymqui.github.io/photo/info/index_friend.js"></SCRIPT>');
}else if(window.yunalbum){
    document.write('<SCRIPT TYPE="text/javascript" LANGUAGE="javascript" SRC="https://ymqui.github.io/photo/info/index_yun.js"></SCRIPT>');
}else if(window.restalbum){
    document.write('<SCRIPT TYPE="text/javascript" LANGUAGE="javascript" SRC="https://ymqui.github.io/photo/info/index_restaurant.js"></SCRIPT>');
