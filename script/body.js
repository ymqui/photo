<!--
  ...
  document.write('<p>&nbsp;');
  document.write('<div id="wrap" style="text-align: center;">');
  document.write('<div id="text" style="font-size: '+fsize+' color:'+color_3+';text-align:left;display:inline-block;padding-left: 3em;text-indent:-3em;">&nbsp;</div>');
  document.write('</div>');
