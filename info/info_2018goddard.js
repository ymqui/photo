...
//    this[1][i++]  = (["Outdoor activity","户外活动"])[cn_ind];
    ...
    this[1][i++]  = (["Distance learning at home","在家远程上课"])[cn_ind];
//    this[0][i]    = "20200414_1";
//    this[1][i++]  = (["Making music","在健身房玩得很开心"])[cn_ind];
//    this[0][i]    = "20200414_2";
...
//    this[1][i++]  = (["Painting","画画"])[cn_ind];
    ...
    this[0][i]    = "20200609_1";
    this[1][i++]  = (["Circle time with Mrs. Bailey","Bailey老师带大家上课"])[cn_ind];
    this[0][i]    = "20200612_1";
    this[1][i++]  = (["Making fish prints in playdough","在橡皮泥上印鱼"])[cn_ind];
    this[0][i]    = "20200616_1";
    this[1][i++]  = (["Painting with watercolor","画水彩画"])[cn_ind];
    this[0][i]    = "20200618_1";
    this[1][i++]  = (["Class photo with Ms Bailey and Ms Dave","这个学期的最后一天Bailey老师和Dave老师带大家合影"])[cn_ind];
    this[0][i]    = "20200618_2";
    ...
    this[1][i++]  = (["Painting","画画"])[cn_ind];
    this[0][i]    = "20200701_2";
    this[1][i++]  = (["Riding the pony","骑小马"])[cn_ind];
    this[0][i]    = "20200706_1";
    this[1][i++]  = (["Jumping in the puddle with Alex","和同学Alex在积水里跳"])[cn_ind];
    this[0][i]    = "20200706_2";
    this[1][i++]  = (["Putting felt pieces in crazy straw","将布片串在吸管中"])[cn_ind];
    this[0][i]    = "20200707_1";
    ...
    this[1][i++]  = (["Painting","画画"])[cn_ind];
    this[0][i]    = "20200709_2";
    this[1][i++]  = (["Painting with water color","集体画画"])[cn_ind];
    this[0][i]    = "20200715_1";
    this[1][i++]  = (["Studying pictures of Amazon rainforest fish","研究亚马逊雨林鱼的图片"])[cn_ind];
    this[0][i]    = "20200717_1";
    this[1][i++]  = (["Water day","玩水"])[cn_ind];
    this[0][i]    = "20200717_2";
    ...
    this[0][i]    = "20200724_1";
    makeface[j++] = i;
    this[1][i++]  = (["I am a sloth","我是一只树懒"])[cn_ind];
    this[0][i]    = "20200724_2";
    ...
    this[1][i++]  = (["painting","画画"])[cn_ind];
    this[0][i]    = "20200730_1";
    this[1][i++]  = (["Making a necklace using dyed pasta and hemp cord","用染色的通心粉和麻绳制作项链"])[cn_ind];
    this[0][i]    = "20200805_1";
    this[1][i++]  = (["Painting with bare hand","徒手画画"])[cn_ind];
    this[0][i]    = "20200806_1";
    this[1][i++]  = (["Cutting out a shamrock leaf","切出一片三叶草叶子"])[cn_ind];
    this[0][i]    = "20200811_1";
    this[1][i++]  = (["Water day fun","和同学Alex一起玩水"])[cn_ind];
    this[0][i]    = "20200812_1";
    this[1][i++]  = (["Glued","涂胶水"])[cn_ind];
    this[0][i]    = "20200812_2";
    this[1][i++]  = (["Learning about vegetables from Ms Dave","Dave老师教大家识别蔬菜"])[cn_ind];
    this[0][i]    = "20200813_1";
    this[1][i++]  = (["Dressed as a Mexican","打扮成墨西哥人"])[cn_ind];
    this[0][i]    = "20200814_1";
    this[1][i++]  = (["Test tasting tortilla chips with diffferent salsas","品尝玉米片蘸各种莎莎酱"])[cn_ind];
    this[0][i]    = "20200817_1";
    this[1][i++]  = (["Nature walk with Ms Aya","Aya老师带大家户外活动"])[cn_ind];
    this[0][i]    = "20200819_1";
    this[1][i++]  = (["Painting with a chopstick","用筷子画画"])[cn_ind];
    this[0][i]    = "20200819_2";
    this[1][i++]  = (["Using chopsticks to form a triangle","用筷子摆成一个三角形"])[cn_ind];
    this[0][i]    = "20200824_1";
    this[1][i++]  = (["Cooking","小厨师"])[cn_ind];
    this[0][i]    = "20200825_1";
    this[1][i++]  = (["Water day","玩水"])[cn_ind];
    ...
    this[0][i]    = "20200831_2";
    this[1][i++]  = (["Watching Ms Dave mixing different colors","看Dave老师混合不同颜色"])[cn_ind];
    this[0][i]    = "20200901_1";
    ...
    this[0][i]    = "20200908_1";
    this[1][i++]  = (["Marching band","行进乐队"])[cn_ind];
    this[0][i]    = "20200909_1";
    this[1][i++]  = (["Painting","画画"])[cn_ind];
    this[0][i]    = "20200909_2";
    this[1][i++]  = (["Drawing a train","画火车"])[cn_ind];
    this[0][i]    = "20200910_1";
    this[1][i++]  = (["Listening to stories told by Ms Dave","听Dave老师讲故事"])[cn_ind];
    this[0][i]    = "20200915_1";
    this[1][i++]  = (["Lining up photos and numbers","排照片和数字"])[cn_ind];
    this[0][i]    = "20200916_1";
    this[1][i++]  = (["Looking cool","真酷"])[cn_ind];
    this[0][i]    = "20200921_1";
    ...
    this[0][i]    = "20201009_1";
    this[1][i++]  = (["Painting a giant pumpkin","画大南瓜"])[cn_ind];
    this[0][i]    = "20201013_1";
    ...
    this[1][i++]  = (["Painting","画画"])[cn_ind];
    this[0][i]    = "20201026_1";
    this[1][i++]  = (["Painting a mini pumpkin","涂小南瓜"])[cn_ind];
    this[0][i]    = "20201028_1";
    this[1][i++]  = (["Playing with toy barn","和同学一起玩谷仓玩具"])[cn_ind];
    this[0][i]    = "20201030_1";
    this[1][i++]  = (["Train engineer and his rainbow unicorn friend","火车司机和他的彩虹独角兽朋友"])[cn_ind];
    this[0][i]    = "20201030_2";
    this[1][i++]  = (["Making a spider","做蜘蛛"])[cn_ind];
    this[0][i]    = "20201030_3";
    this[1][i++]  = (["Enjoying the birthday cupcake","吃纸杯生日小蛋糕"])[cn_ind];
    this[0][i]    = "20201030_4";
    this[1][i++]  = (["Goodbye card from friends and teachers","老师和同学们送的告别卡片"])[cn_ind];
    this[0][i]    = "20201030_5";
    this[1][i++]  = (["Goodbye card from friends and teacher","老师和同学们送的告别卡片"])[cn_ind];
