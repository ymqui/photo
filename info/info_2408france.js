...
function initAlbum(){
    ...
    this[0][28] = "2408france_0";
    this[1][28] = "";
    for (var i=29;i<67;i++){
        this[0][i] = "2408france_"+i.toString();
        this[1][i] = "";
    }
    if(window.usechinese){
        ...
        this[1][26] = "在阿尔勒吃午餐。";
        this[1][27] = "在阿尔勒附近的蓬德高鸟类公园"+pagelink("2408frbird&31","看大火烈鸟")+"。";
        this[1][28] = "大火烈鸟。";
        this[1][29] = "游阿尔勒附近的蓬德高鸟类公园。";
        this[1][30] = "在阿尔勒城中心的共和国广场。";
        this[1][31] = "吃完冰后舌头都蓝了。";
        this[1][32] = "球球在阿尔勒的古罗马剧场前。";
        this[1][33] = "球球在阿尔勒的古罗马剧场前做侧手翻。";
        this[1][34] = "阿尔勒的古罗马剧场。";
        this[1][35] = "在阿尔勒的一家店铺前。";
        this[1][36] = "游马赛的圣母加德大教堂。";
        this[1][37] = "游马赛的圣母加德大教堂。";
        this[1][38] = "马赛老港。";
        this[1][39] = "阿尔勒的一幅街头壁画。";
        this[1][40] = "在里昂的高卢古罗马剧场。";
        this[1][41] = "在里昂的高卢罗马博物馆。";
        this[1][42] = "参观里昂的高卢罗马博物馆。";
        this[1][43] = "参观里昂的高卢罗马博物馆。";
        this[1][44] = "在里昂的富维耶圣母院。";
        this[1][45] = "在巴黎乘地铁。";
        this[1][46] = "游巴黎的埃菲尔铁塔。";
        this[1][47] = "游巴黎的埃菲尔铁塔。";
        this[1][48] = "游巴黎的埃菲尔铁塔。";
        ...
        this[1][27] = pagelink("2408frbird&31","Watching greater flamingos")+" in Parc Ornithologique du Pont de Gau near Arles.";
        ...
        this[1][31] = "Blue tongue after drinking blue raspberry icee.";
        this[1][32] = "Nathan in front of the Roman amphitheatre in Arles.";
        this[1][33] = "Doing a cartwheel in front of the Roman amphitheatre in Arles.";
        this[1][34] = "Arènes d'Arles: the Roman amphitheatre in Arles.";
        this[1][35] = "In front of a shop display in Arles.";
        this[1][36] = "Notre-Dame de la Garde in Marseille.";
        this[1][37] = "View of Marseille from Notre-Dame de la Garde.";
        this[1][38] = "The old port of Marseille.";
        this[1][39] = "A street painting in Arles.";
        this[1][40] = "At the Gallo-RomanTheater in Lyon.";
        this[1][41] = "Visiting the Gallo-Roman Museum of Lyon-Fourvière.";
        this[1][42] = "Visiting the Gallo-Roman Museum of Lyon-Fourvière.";
        this[1][43] = "Visiting the Gallo-Roman Museum of Lyon-Fourvière.";
        this[1][44] = "At the Basilique Notre-Dame de Fourvière in Lyon.";
        this[1][45] = "Riding the metro in Paris.";
        ...
        this[1][49] = "Visiting the Eiffel Tower in Paris.";
        this[1][50] = "Visiting the Arc de Triomphe in Paris.";
        this[1][51] = "The Arc de Triomphe in Paris.";
        this[1][52] = "The Winged Victory of Samothrace in the Louvre Museum.";
        this[1][53] = "Visiting the Louvre Museum.";
        this[1][54] = "Mona Lisa at the Louvre Museum.";
        this[1][55] = "Mona Lisa at the Louvre Museum.";
        this[1][56] = "Mona Lisa at the Louvre Museum.";
        this[1][57] = "At the courtyard of the Louvre Museum.";
        this[1][58] = "Sitting with the teddy bears in Paris.";
        this[1][59] = "Visiting the Panthéon in Paris.";
        this[1][60] = "Visiting the Panthéon in Paris.";
        this[1][61] = "Taking the river cruise on the Seine in Paris.";
        this[1][62] = "Taking the river cruise on the Seine in Paris.";
        this[1][63] = "Taking the river cruise on the Seine in Paris.";
        this[1][64] = "Paris street.";
        this[1][65] = "Night view of the Eiffel Tower.";
        this[1][66] = "Night view of the Eiffel Tower.";
    }
}
