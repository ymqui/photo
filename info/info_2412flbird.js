...
function initAlbum(){
    ...
    if(window.usechinese){
        ...
        this[1][15] = "斯氏鵟，未成年浅色型，蛙塘野生动物管理区。";
        this[1][16] = "斯氏鵟，未成年暗色型，蛙塘野生动物管理区。";
        this[1][17] = "斯氏鵟，浅色型，蛙塘野生动物管理区。";
        this[1][18] = "斯氏鵟，未成年暗色型，蛙塘野生动物管理区。";
        this[1][19] = "斯氏鵟，未成年浅色型，蛙塘野生动物管理区。";
        this[1][20] = "斯氏鵟，未成年暗色型，蛙塘野生动物管理区。";
        this[1][21] = "宽尾拟八哥，蛙塘野生动物管理区。";
        this[1][22] = "赤肩鵟，佛罗里达亚种，蛙塘野生动物管理区。";
        this[1][23] = "赤肩鵟，佛罗里达亚种，蛙塘野生动物管理区。";
        ...
        this[1][15] = "Swainson's Hawk, immature light morph, Frog Pond WMA.";
        this[1][16] = "Swainson's Hawk, juvenile dark morph, Frog Pond WMA.";
        this[1][17] = "Swainson's Hawk, light morph, Frog Pond WMA.";
        this[1][18] = "Swainson's Hawk, juvenile dark morph, Frog Pond WMA.";
        this[1][19] = "Swainson's Hawk, immature light morph, Frog Pond WMA.";
        this[1][20] = "Swainson's Hawk, juvenile dark morph, Frog Pond WMA.";
        this[1][21] = "Boat-tailed Grackle, Frog Pond WMA.";
        this[1][22] = "Red-shouldered Hawk, extimus, Frog Pond WMA.";
        this[1][23] = "Red-shouldered Hawk, extimus, Frog Pond WMA.";
