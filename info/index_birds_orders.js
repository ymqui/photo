<!--
  ...
  j=0, family = [];
  family[j++] = new myFamily("APTERYGIDAE","鹬鸵科","Kiwis","鹬鸵");
  orders[i++] = new myOrder("APTERYGIFORMES","鹬鸵目","Kiwis","鹬鸵",family);
  ...
  family[j++] = new myFamily("PHASIANIDAE","雉科","Partridges, Grouse, Turkeys and Old World Quail","山鹑，松鸡，火鸡和旧大陆的鹑");
  ...
  j=0, family = [];
  family[j++] = new myFamily("PODARGIDAE","蟆口鸱科","Frogmouths","蟆口鸱");
  orders[i++] = new myOrder("PODARGIFORMES","蟆口鸱目","Frogmouths","蟆口鸱",family);
  ...
  family[j++] = new myFamily("PSOPHIIDAE","喇叭鸟科","Trumpeters","喇叭鸟");
  ...
  j=0, family = [];
  family[j++] = new myFamily("PODICIPEDIDAE","鸊鷉科","Grebes","鸊鷉");
  orders[i++] = new myOrder("PODICIPEDIFORMES","鸊鷉目","Grebes","鸊鷉",family);
  ...
  j=0, family = [];
  family[j++] = new myFamily("TURNICIDAE","三趾鹑科","Buttonquail","三趾鹑科");
  family[j++] = new myFamily("BURHINIDAE","石鸻科","Thick-knees","石鸻");
  family[j++] = new myFamily("CHIONIDAE","鞘嘴鸥科","Sheathbills","鞘嘴鸥");
  family[j++] = new myFamily("PLUVIANELLIDAE","麦哲伦鸻科","Magellanic Plover","麦哲伦鸻");
  ...
  family[j++] = new myFamily("SCOLOPACIDAE","鹬科","Sandpipers, Phalaropes, and Allies","矶鹬和瓣蹼鹬等");
  ...
  family[j++] = new myFamily("HYDROBATIDAE","海燕科","Storm-Petrels","小海燕");
  family[j++] = new myFamily("PROCELLARIIDAE","鹱科","Shearwaters and Petrels","鹱和海燕");
  ...
  j=0, family = [];
  family[j++] = new myFamily("THRESKIORNITHIDAE","鹮科","Ibises and Spoonbills","朱鹭和琵鹭");
  ...
  family[j++] = new myFamily("SAGITTARIIDAE","蛇鹫科","Secretarybird","蛇鹫");
  ...
  j=0, family = [];
  family[j++] = new myFamily("TYTONIDAE","草鸮科","Barn Owls","仓鸮");
  ...
  family[j++] = new myFamily("PSITTACULIDAE","旧大陆鹦鹉科","Old World Parrots","旧大陆鹦鹉");
  ...
  family[j++] = new myFamily("SAPAYOIDAE","阔嘴鸟科","Sapayoa","阔嘴霸鹟");
  ...
  family[j++] = new myFamily("FORMICARIIDAE","蚁鸫科","Ant-thrushes","蚁鸫");
  family[j++] = new myFamily("GRALLARIIDAE","蚁八色鸫科","Ant-pittas","蚁鸫");
  ...
  family[j++] = new myFamily("PARDALOTIDAE","斑食蜜鸟科","Gerygones and allies","食蜜鸟");
  ...
  family[j++] = new myFamily("PARAMYTHIIDAE","冠啄果鸟科","Painted Berrypeckers","啄果鸟");
  ...
  family[j++] = new myFamily("PSOPHODIDAE","啸冠鸫科","Whipbirds, Jewel-babblers and Quail-thrushes","鹑鸫和丽鸫");
  family[j++] = new myFamily("CINCLOSOMATIDAE","啸冠鸫科","Quail-thrushes and Jewel-babblers","鹑鸫和丽鸫");
  ...
  family[j++] = new myFamily("CAMPEPHAGIDAE","山椒鸟科","Cuckooshrikes","山椒鸟");
  family[j++] = new myFamily("MOHOUIDAE","黄头刺莺科","Whitehead & allies","刺莺");
  family[j++] = new myFamily("NEOSITTIDAE","澳鳾科","Sittellas","澳鳾");
  family[j++] = new myFamily("EULACESTOMATIDAE","肉垂鵙雀鹟科","Ploughbill","肉垂鵙雀鹟");
  family[j++] = new myFamily("OREOICIDAE","钟鹟科","Australo-Papuan Bellbirds","钟鹟");
  ...
  family[j++] = new myFamily("VIREONIDAE","绿鹃科","Vireos","莺雀");
  ...
  family[j++] = new myFamily("PETROICIDAE","鸲鹟科","Australasian Robins","澳大拉西亚鸲鹟");
  ...
  family[j++] = new myFamily("STENOSTIRIDAE","莺鹟科","Fairy Flycatchers","仙莺等");
  ...
  family[j++] = new myFamily("PNOEPYGIDAE","鳞胸鹪鹛科","Wren-babblers","鹪鹛");
  ...
  family[j++] = new myFamily("HYLIIDAE","绿莺科","Hylias","绿莺");
  ...
  family[j++] = new myFamily("BERNIERIDAE","马岛鹎科","Malagasy Warblers","马岛鹎");
  family[j++] = new myFamily("CISTICOLIDAE","扇尾莺科","Cisticolas","扇尾莺");
  family[j++] = new myFamily("SYLVIIDAE","莺科","Old World Warblers","旧大陆莺");
  ...
  family[j++] = new myFamily("TIMALIIDAE","画眉科","Babblers and Scimitar-Babblers","画眉");
  ...
  family[j++] = new myFamily("MODULATRICIDAE","纹喉䳭科","Dapplethroat and allies","纹喉䳭");
  ...
  family[j++] = new myFamily("PLOCEIDAE","织布鸟科","Weavers","织布鸟");
  family[j++] = new myFamily("ESTRILDIDAE","梅花雀科","weaver-finches","梅花雀");
  ...
  family[j++] = new myFamily("MOTACILLIDAE","鹡鸰科","Wagtails and Pipits","鹡和鸰鹨 ");
  ...
  family[j++] = new myFamily("EMBERIZIDAE","鹀科","New World Sparrows and Allies","美洲鹀");
  family[j++] = new myFamily("PASSERELLIDAE","美洲麻雀科","New World Sparrows","美洲麻雀");
  family[j++] = new myFamily("CALYPTOPHILIDAE","拟䳭唐纳雀科","Chat-tanagers","拟䳭唐纳雀");
  ...
  family[j++] = new myFamily("THRAUPIDAE","裸鼻雀科","Tanagers and Allies","唐纳雀");
  orders[i++] = new myOrder("PASSERIFORMES","雀形目","Perching Birds","雀",family);
  ...
  var py  =  { 额:"e2", 鹅:"e2", 鹗:"e4", 阿:"a1", 恶:"e4", 鸸:"er2",无:"wu2",及:"ji2", 斗:"dou4",树:"shu4",茶:"cha2",林:"lin2",白:"bai2",赤:"chi4",肉:"rou4",竹:"zhu2",非:"fei1", 环:"huan2",平:"ping2",横:"heng2",苍:"cang1",娇:"jiao1",玄:"xuan2",䳍:"gong1",
      拿:"na2",绿:"lv4",艾:"ai4",鸡:"ji1",狐:"hu2",曲:"qu1",牙:"ya2",稀:"xi1",虎:"hu3", 海:"hai3",喉:"hou2",太:"tai4",沙:"sha1",雉:"zhi4",珠:"zhu1",齿:"chi3",麦:"mai4",群:"qun2", 东:"dong1",鸻:"heng2",尖:"jian1",杓:"shao2",连:"lian2",孔:"kong3",棕:"zong1",
      巨:"ju4",夜:"ye4",克:"ke4",鹭:"lu4",唧:"ji1",麻:"ma2",叶:"ye4",苦:"ku3",牡:"mu3", 鹫:"jiu4",华:"hua2",灰:"hui1",叉:"cha1",粉:"fen3",三:"san1",牛:"niu2",本:"ben3",维:"wei2", 面:"mian2",脸:"lian3",州:"zhou1",鹰:"ying1",方:"fang1",蕉:"jiao1",仙:"xian1",
      细:"xi4",紫:"zi3",羽:"yu3",蛎:"li4",鹬:"yu4",矶:"ji1",丽:"li4",笛:"di2",赫:"he4", 金:"jin1",丘:"qiu1",丹:"dan1",蓑:"suo1",厚:"hou4",半:"ban4",云:"yun2",侏:"zhu1",霍:"huo4", 田:"tian2",青:"qing1",领:"ling3",翘:"qiao4",端:"duan1",桑:"sang1",鞘:"qiao4",
      大:"da4",地:"di4",崖:"ya2",鸦:"ya1",鸽:"ge1",耳:"er3",卡:"ka3",密:"mi4",哑:"ya3", 伞:"san3",滨:"bin1",噪:"zao4",趾:"zhi3",鸠:"jiu1",威:"wei1",朱:"zhu1",裸:"luo3",池:"chi2", 冰:"bing1",鹦:"ying1",绒:"rong2",沼:"zhao3",星:"xing1",阳:"yang2",灯:"deng1",塍:"cheng2",
      栖:"qi1",雨:"yu3",各:"ge4",颏:"ke1",木:"mu4",哥:"ge1",渡:"du4",扑:"pu1",哀:"ai1", 鸱:"chi1",翠:"cui4",狗:"gou3",汁:"zhi1",游:"you2",淡:"dan4",南:"nan2",帆:"fan1",艳:"yan4", 园:"yuan2",丁:"ding1",鹪:"jiao1",鹩:"liao2",蜂:"feng1",芒:"mang2",亨:"heng1",船:"chuan2",
      伯:"bo2",暗:"an4",丝:"si1",蜡:"la4",鹀:"wu2",犀:"xi1",乐:"le4",欧:"ou1",马:"ma3", 带:"dai4",钩:"gou1",呆:"dai1",劳:"lao2",百:"bai3",鹎:"bei1",罗:"luo2",绣:"xiu4",鹛:"mei2", 圆:"yuan2",脚:"jiao3",嘲:"chao2",丛:"cong2",缝:"feng2",藏:"zang4",僧:"seng1",长:"chang2",
      鸲:"qu2",鹡:"ji2",圃:"pu3",布:"bu4",河:"he2",斯:"si1",鸬:"lu2",苏:"su1",犁:"li2", 玫:"mei2",昏:"hun1",弯:"wan1",腿:"tui3",花:"hua1",灶:"zao4",文:"wen2",刘:"liu2",阔:"kuo4", 窜:"cuan4",鸰:"ling2",唐:"tang2",松:"song1",枞:"cong1",爪:"zhao3",鲸:"jing1",鵟:"kuang2",
      鹉:"wu3",热:"re4",勒:"le4",鹕:"hu2",霸:"ba4",拉:"la1",鹚:"ci2",波:"bo1",簇:"cu4", 蚋:"rui4",鸵:"tuo2",贼:"zei2",反:"fan3",信:"xin4",纹:"wen2",黑:"hei1",燕:"yan4",岩:"yan2", 潜:"qian2",鳽:"jian1",靛:"dian4",囱:"cong1",灵:"ling2",镰:"lian2",交:"jiao1",橡:"xiang4",
      鹈:"ti2",漠:"mo4",姬:"ji1",刺:"ci4",吉:"ji2",骨:"gu3",鴗:"li4",鼻:"bi2",吸:"xi1", 蛇:"she2",戴:"dai4",咬:"yao3",巾:"jin1",加:"jia1",秋:"qiu1",费:"fei4",食:"shi2",疣:"you2", 榛:"zhen1",洲:"zhou1",叫:"jiao4",纯:"chun2",针:"zhen1",铅:"qian1",鹲:"meng2",虫:"chong2",
      褐:"he4",普:"pu3",弗:"fu2",尼:"ni2",䴙:"pi4",西:"xi1",八:"ba1",旅:"lv3",籽:"zi3", 北:"bei3",毛:"mao2",鹞:"yao4",烟:"yan1",果:"guo3",家:"jia1",柳:"liu3",胁:"xie2",隐:"yin3", 小:"xiao3",神:"shen2",角:"jiao3",短:"duan3",铜:"tong2",蓬:"peng2",鸢:"yuan1",城:"cheng2",
      浮:"fu2",黎:"li2",企:"qi3",达:"da2",鵙:"ju2",佛:"fo2",鹤:"he4",琵:"pi2",蜜:"mi4", 火:"huo3",石:"shi2",印:"yin4",铁:"tie3",苇:"wei3",锈:"xiu4",恺:"kai3",岛:"dao3",鹠:"liu2", 冠:"guan1",山:"shan1",鹋:"miao2",水:"shui3",宽:"kuan1",跷:"qiao1",剪:"jian3",相:"xiang1",
      鸭:"ya1",色:"se4",鹱:"hu4",蹼:"pu3",鸥:"ou1",喜:"xi3",埃:"ai1",雅:"ya3",眉:"mei2",主:"zhu3",多:"duo1",刀:"dao1",翅:"chi4",嘴:"zui3",鹊:"que4",氏:"shi4",雪:"xue3",赭:"zhe3", 垂:"chui2",鸯:"yang1",鹳:"guan4",鸳:"yuan1",王:"wang2",鹇:"xian2",鸣:"ming2",橙:"cheng2",
      乌:"wu1",披:"pi1",栗:"li4",亚:"ya4",安:"an1",鱼:"yu2",榈:"lv2",鹂:"li2",番:"fan1",桂:"gui4",买:"mai3",䴓:"shi1",森:"sen1",瓣:"ban4",隼:"sun3",矛:"mao2",眼:"yan3",螺:"luo2", 雕:"diao1",锥:"zhui1",顶:"ding3",鹟:"weng1",鸫:"dong1",秧:"yang1",胸:"xiong1",胜:"sheng4", 
      腹:"fu4",巴:"ba1",比:"bi3",库:"ku4",极:"ji2",科:"ke1",歌:"ge1",拟:"ni3",头:"tou2",颊:"jia2",油:"you2",走:"zou3",鼠:"shu3",喙:"hui4",画:"hua4",鬼:"gui3",辉:"hui1",掩:"yan3", 啄:"zhuo2",丑:"chou3",笑:"xiao4",原:"yuan2",风:"feng1",颈:"jing3",黄:"huang2",靓:"liang4",
      䴘:"ti1",日:"ri4",须:"xu1",第:"di4",棘:"ji2",杂:"za2",澳:"ao4",翼:"yi4",绯:"fei1",臀:"tun2",蚊:"wen2",智:"zhi4",橄:"gan3",榄:"lan3",蟹:"xie4",豆:"dou4",麝:"she4",优:"you3", 扇:"shan4",天:"tian1",点:"dian3",硬:"ying4",刚:"gang1",鹑:"chun2",中:"zhong1",蝗:"huang2",
      几:"ji3",壁:"bi4",帝:"di4",锡:"xi1",叭:"ba1",喇:"la3",法:"fa3",伊:"yi1",薮:"sou3",奎:"kui2",滑:"hua2",背:"bei4",穴:"xue2",流:"liu2",美:"mei3",鳞:"lin2",楔:"xie1",高:"gao1", 枕:"zhen3",肩:"jian1",鹮:"huan2",猩:"xing1",舰:"jian4",旋:"xuan2",响:"xiang3",煌:"huang2",
      伍:"wu3",思:"si1",距:"ju4",舞:"wu3",蒂:"di4",䳭:"ji2",那:"na4",沃:"wo4",酋:"qiu2",莱:"lai2",䴕:"lie4",瑰:"gui1",泰:"tai4",坦:"tan3",沟:"gou1",鸺:"xiu1",草:"cao3",锤:"chui2",远:"yuan3",翁:"weng1",冬:"dong1",蝇:"ying2",卷:"juan3",鲣:"jian1",塚:"zhong3",光:"guang1",
      纳:"na4",蚁:"yi3",菊:"ju2",墨:"mo2",和:"he2",髭:"zi1",哈:"ha1",蛙:"wa1",斑:"ban1",蓝:"lan2",军:"jun1",尾:"wei3",银:"yin2",雀:"que4",琴:"qin2",宝:"bao3",暴:"bao4",红:"hong2",啸:"xiao4",洋:"yang2",仓:"cang1",莺:"ying1",凤:"feng4",鹃:"juan1",钟:"zhong1",椋:"liang2",
      泽:"ze2",孤:"gu1",格:"ge2",利:"li4",迪:"di2",奥:"ao4",可:"ke3",五:"wu2",口:"kou3",彩:"cai3",翻:"fan1",腰:"yao1",鸨:"bao3",雁:"yan4",鹨:"liu4",月:"yue3",舌:"she2",膀:"bang3",翎:"ling2",通:"tong1",鸮:"xiao1",猛:"meng3",椒:"jiao1",鸟:"niao3",声:"sheng1",双:"shuang1"};
