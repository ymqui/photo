<!--
  ...
  var family  = [];
  var j = 0;
  family[j++] = new newFamily("MEGAPODIIDAE","塚雉科","Megapodes","塚雉");
  ...
  family[j++] = new newFamily("PLATYSTEIRIDAE","疣眼鹟科","Wattle-eyes and Batises","疣眼鹟和蓬背鹟");
  ...
  family[j++] = new newFamily("DULIDAE","棕榈䳭科","Palmchat","棕榈䳭");
  ...
  family[j++] = new newFamily("MODULATRICIDAE","纹喉䳭科","Dapplethroat and allies","纹喉䳭");
  ...
  family[j++] = new newFamily("CALYPTOPHILIDAE","拟䳭唐纳雀科","Chat-tanagers","拟䳭唐纳雀");
  ...
  family[j++] = new newFamily("ICTERIIDAE","黄胸大䳭莺科","Yellow-breasted Chat","黄胸大䳭莺");
