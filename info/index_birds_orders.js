...
pt_back.push(["Agadir Beach","阿加迪尔海滩"],["Alameda Central","阿拉米达中央公园"],["Alaska","阿拉斯加州"],["Art.+Agape","艾盖浦艺术别墅酒店"],["Ash.+Sanctuary","灰谷鸟类保护区"],["Aurocher Hotel","奥罗歇旅馆"],
    ...
    ["Black Point Park.+","黑角公园及码头"],["Blackwater NWR","黑水NWR"],["Blue Mountains NP","蓝山NP"],["Block.+Rhode Island","罗德岛州布洛克岛至朱迪思角轮渡"],["Bocca.+Serchio","塞尔基奥河口"],["Bois.+Boulogne","布洛涅森林"],
    ["Bowers Beach","鲍尔斯海滩"],["Box.+Road","盒子峡谷路"],["Cabo.+NWR","卡波罗霍NWR"],["California","加利福尼亚州"],["Cambridge","剑桥市"],["Campania","坎帕尼亚大区"],["Canada","加拿大"],["Cannon Beach","卡农海滩"],
    ["Cape Flattery","夫拉特角"],["Cape Hatteras","哈特拉斯角"],["Cape May.+SP","五月岬SP"],["Casa[^,]+ttat","卡萨布兰卡-塞塔特大区"],["Ceiba.+Inn","西巴乡村客栈"],["Central Park","中央公园"],["Cerro.+Cruz","十字架山"],
    ...
    ["Drâa.+let","德拉-塔菲拉勒特大区"],["Dunn.+Ann","圣安堂区奥乔里奥斯邓恩河瀑布"],["Eastern Neck NWR","东内克NWR"],["Edwin.+NWR","埃德温·福赛斯NWR"],["El Hank.+blanca","卡萨布兰卡埃尔·汉克灯塔"],["El Pipila Monument","皮毕拉纪念碑"],
    ["Erg Chebbi","切比沙丘"],["Etang.+Crau","圣马丁德克罗镇桤木池塘"],["Fatt.+Pisa","比萨市L'Olmetto农场酒店"],["Fes.+Meknès","非斯-梅克内斯大区非斯麦地那"],["Fjallsárlón","Fjallsárlón冰河湖"],["Florence","佛罗伦萨市"],
    ["Fort McHenry","麦克亨利堡"],["France","法国"],["Frederick","弗雷德里克市"],["Frog Pond WMA","蛙塘WMA"],["Fucecchio Marsh","富切基奥沼泽"],["Gamboa","甘博阿镇"],["Georgia","乔治亚州"],
    ...
    ["Magee.+Area","玛吉沼泽WR"],["Maine","缅因州"],["Manasquan Inlet","马纳斯泉海口"],["Mariner.+Park","水手角公园"],["Maryland Heights","马里兰高地一带"],["Mathes.+Park","马西森硬木公园"],["Mexico City","墨西哥城"],
    ["Michigan","密西根州"],["Midelt","米德勒特"],["Montego Bay","蒙特哥湾"],["Montezuma NWR","蒙特祖玛NWR"],["Morazán Park","莫拉桑公园"],["Morro.+Bay","莫罗湾莫罗岩"],["Morse.+Lure","路尔湖摩士公园"],
    ["Mouth.+Lagni","Regi Lagni运河口"],["Nevada","内华达州"],["New York City","纽约市"],["Nianbadu","廿八都"],["Northwestern Region","西北地区"],["Ocean City","大洋城"],["Ohio","俄亥俄州"],["Old Hos.+Park","老医院公园"],
    ["Olympic NP","奥林匹克NP"],["Ontario","安大略省"],["Oregon","俄勒冈州"],["Ouarzazate","瓦尔扎扎特"],["Panama","巴拿马"],["Paris","巴黎市"],["Park.+Guarantees","社会保障公园"],["Patapsco.+Henryton","帕塔普斯科河谷SP"],
    ["Paton.+Hummingbirds","佩顿蜂鸟中心"],["Pennyfield Lock","彭尼菲尔德闸"],["Pitt.+Causeway","皮特街堤道"],["Plantation Preserve","种植园保留地"],["Presque.+Erie","伊利市普雷斯克岛SP"],["Red Rocks Park","红石公园"],
    ...
    ["Scott.+Colle.*","斯科茨代尔市社区大学"],["Scotts.+Road","斯科茨码头路"],["Shamrock.+Center","三叶草公园"],["Souss-Massa","苏斯-马塞大区"],["South Cape May Meadows","南五月岬草甸"],
    ["Stellwag.+Sanctuary","斯特尔瓦根浅滩国家海洋保护区"],["Summer Palace","颐和园"],["Sunset Park","日落公园"],["Taoranting Park","陶然亭公园"],["The Bund.+Shanghai","上海外滩"],["Tjörnin.+Reykjavík","雷克雅未克托宁湖"],
    ["Truitts.+Road","特鲁伊特码头路"],["Tucson","图森市"],["Two.+May","五月岬两英里码头"],["Tybee Island","泰碧岛"],["United Kingdom","英国"],["Van.+Hamilton","汉密尔顿市范瓦格纳湖滩"],["Vermont","佛蒙特州"],
    ["Violettes Lock","紫罗兰闸"],["Waggoner's Gap.+","瓦格纳山口观鹰台"],["Washington","华盛顿州"],["Waterton Canyon","沃特顿峡谷"],["Wenlock WMA","温洛克WMA"],["Western Region","西部地区"],["Wheat Ridge","麦岭市"],["Xiamen","厦门"],
    ["Xianxia.+Trail","仙霞关古道"],["Yokuts Park","约库特公园"],["Yongding Hongkeng Tulou","永定洪坑土楼"],["Yuan.+Park","圆明园"]);
