...
var orders = myOrder([
    ...
    ["PASSERIFORMES","雀形","ACANTHISITTIDAE","刺鹩","SAPAYOIDAE","阔嘴霸鹟","PHILEPITTIDAE","裸眉鸫","EURYLAIMIDAE","阔嘴鸟","CALYPTOMENIDAE","绿阔嘴鸟","PITTIDAE","八色鸫","FURNARIIDAE","灶鸟","THAMNOPHILIDAE","蚁鸟",
     ...
     "HYLIOTIDAE","丛莺","TROGLODYTIDAE","鹪鹩","POLIOPTILIDAE","蚋莺","SITTIDAE","䴓","TICHODROMIDAE","旋壁雀","CERTHIIDAE","旋木雀","SALPORNITHIDAE","斑旋木雀","MIMIDAE","嘲鸫","STURNIDAE","椋鸟","BUPHAGIDAE","牛椋鸟","TURDIDAE","鸫",
     "MUSCICAPIDAE","鹟","CINCLIDAE","河乌","CHLOROPSEIDAE","叶鹎","DICAEIDAE","啄花鸟","NECTARINIIDAE","太阳鸟","PASSERIDAE","雀","PLOCEIDAE","织雀","ESTRILDIDAE","梅花雀","VIDUIDAE","维达雀","PEUCEDRAMIDAE","绿森莺","PRUNELLIDAE","岩鹨",
