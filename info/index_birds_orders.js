...
pt_back.push(["Alameda Central","阿拉米达中央公园"],["Alaska","阿拉斯加州"],["Art.+Agape","艾盖浦艺术别墅酒店"],["Ash.+Sanctuary","灰谷鸟类保护区"],["Aurocher Hotel","奥罗歇旅馆"],["Auvergne-Rhône-Alpes","奥弗涅-罗纳-阿尔卑斯大区"],
    ...
    ["El Pipila Monument","皮毕拉纪念碑"],["Erg Chebbi","切比沙丘"],["Etang.+Crau","圣马丁德克罗镇桤木池塘"],["Fjallsárlón","Fjallsárlón冰河湖"],["Florence","佛罗伦萨市"],["Fort McHenry","麦克亨利堡"],["France","法国"],
    ["Frederick","弗雷德里克市"],["Frog Pond WMA","蛙塘WMA"],["Fucecchio Marsh","富切基奥沼泽"],["Gamboa","甘博阿镇"],["Georgia","乔治亚州"],["Golfklú.+jarnarnes","塞尔特贾纳内斯高尔夫球场"],["Grassy Key","草岛"],
    ["Guanajuato City","瓜纳华托城"],["Guanajuato","瓜纳华托州"],["Halibut.+SP","大比目鱼角SP"],["Haute-Savoie","上萨瓦省"],["Herit.+Park","遗产岛公园"],["Hobuck Beach","霍巴克海滩"],["Holywell Park","霍利韦尔公园"],
