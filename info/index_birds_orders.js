...
pt_back.push(["Alameda Central","阿拉米达中央公园"],["Alaska","阿拉斯加州"],["Art.+Agape","艾盖浦艺术别墅酒店"],["Ash.+Sanctuary","灰谷鸟类保护区"],["Auvergne-Rhône-Alpes","奥弗涅-罗纳-阿尔卑斯大区"],["Bakkatjörn","巴卡特约恩湖"],
    ...
    ["Drâa.+let","德拉-塔菲拉勒特大区"],["Dunn.+Ann","圣安堂区奥乔里奥斯邓恩河瀑布"],["Eastern Neck NWR","东内克NWR"],["Edwin.+NWR","埃德温·福赛斯NWR"],["El Pipila Monument","皮毕拉纪念碑"],["Etang.+Crau","圣马丁德克罗镇桤木池塘"],
    ["Fjallsárlón","Fjallsárlón冰河湖"],["Florence","佛罗伦萨市"],["Fort McHenry","麦克亨利堡"],["France","法国"],["Frederick","弗雷德里克市"],["Frog Pond WMA","蛙塘WMA"],["Fucecchio Marsh","富切基奥沼泽"],["Gamboa","甘博阿镇"],
    ["Georgia","乔治亚州"],["Golfklú.+jarnarnes","塞尔特贾纳内斯高尔夫球场"],["Grassy Key","草岛"],["Guanajuato City","瓜纳华托城"],["Guanajuato","瓜纳华托州"],["Halibut.+SP","大比目鱼角SP"],["Haute-Savoie","上萨瓦省"],
    ["Herit.+Park","遗产岛公园"],["Hobuck Beach","霍巴克海滩"],["Holywell Park","霍利韦尔公园"],["Homer.+Park","荷马古德尔斯基公园"],["Hope.+Gardens","霍普植物园"],["Hólmavík","侯尔马维克小镇"],["Hót.+hóll","Laugarhóll旅馆"],
    ["Iceland","冰岛"],["Indian.+Inlet","印第安河入海口"],["Italy","意大利"],["Jiang.+meiren","江山睡美人"],["Jiangsh.+Greenway","江山港滨水绿道"],["Jimei","集美"],["Jingshan Park","景山公园"],["Jones B.+SP","琼斯海滩SP"],
    ["Jökulsárlón","杰古沙龙冰河湖"],["Katmai.+Preserve","卡特迈NP"],["Kennedy Park","肯尼迪公园"],["Key West","西礁岛"],["Kjarnaskógur","Kjarnaskógur森林"],["Lake Massaciuccoli","马萨丘科利湖"],["La Sabana Park","萨瓦纳公园"],
    ["Látrabjarg","拉特拉尔角"],["Lianhua.+Park","莲花山公园"],["Little.+Lagoon","小埃斯特罗泻湖"],["Littleton","利特尔顿市"],["Longyan","龙岩市"],["Mackinac Island","麦基诺岛"],["Madera.+Trail","马德拉峡谷嘉莉国家山道"],
    ["Madera.+Lodge","马德拉峡谷圣丽塔旅馆"],["Magee.+Area","玛吉沼泽WR"],["Maine","缅因州"],["Manasquan Inlet","马纳斯泉海口"],["Mariner.+Park","水手角公园"],["Maryland Heights","马里兰高地一带"],["Matheson.+Park","马西森硬木公园"],
    ["Mexico City","墨西哥城"],["Michigan","密西根州"],["Montego Bay","蒙特哥湾"],["Montezuma NWR","蒙特祖玛NWR"],["Morazán Park","莫拉桑公园"],["Morro.+Bay","莫罗湾莫罗岩"],["Morse.+Lure","路尔湖摩士公园"],
    ...
    ["Paton.+Hummingbirds","佩顿蜂鸟中心"],["Pennyfield Lock","彭尼菲尔德闸"],["Pitt.+Causeway","皮特街堤道"],["Plantation Preserve","种植园保留地"],["Red Rocks Park","红石公园"],["Riley.+Lock","莱利闸"],["Rincón","林孔市"],
    ["Rocky.+NWR","落基山阿森纳NWR"],["Saint Andrew","圣安德鲁堂区"],["Saint James","圣詹姆斯堂区"],["San San.+Road","三三派出所路"],["Savannah NWR","萨凡纳NWR"],["Scottsdale.+College.*","斯科茨代尔市社区大学"],
    ...
    ["Taoranting Park","陶然亭公园"],["The Bund.+Shanghai","上海外滩"],["Tjörnin.+Reykjavík","雷克雅未克托宁湖"],["Truitts.+Road","特鲁伊特码头路"],["Tucson","图森市"],["Two.+May","五月岬两英里码头"],["Tybee Island","泰碧岛"],
    ["United Kingdom","英国"],["Van.+Hamilton","汉密尔顿市范瓦格纳湖滩"],["Vermont","佛蒙特州"],["Violettes Lock","紫罗兰闸"],["Waggoner's Gap.+","瓦格纳山口观鹰台"],["Washington","华盛顿州"],["Waterton Canyon","沃特顿峡谷"],
    ["Wenlock WMA","温洛克WMA"],["Western Region","西部地区"],["Wheat Ridge","麦岭市"],["Xiamen","厦门"],["Xianxia.+Trail","仙霞关古道"],["Yokuts Park","约库特公园"],["Yongding Hongkeng Tulou","永定洪坑土楼"],["Yuan.+Park","圆明园"]);
