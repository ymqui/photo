...
function initAlbum(){
    ...
    this[1][i++] = (["Bamboo rafting down the Rio Grande in Port Antonio during the "+pagelink("2512jamaica","vacation in Jamaica"),pagelink("2512jamaica","牙买加度假")+"时在波特安东尼奥乘坐竹筏漂流里奥格兰德河"])[cn_ind];
