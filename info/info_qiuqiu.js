...
var pagelist   = [["1806myrtlebeach","6/2018 Myrtle Beach, South Carolina","6/2018 南卡罗来纳州美特尔海滩度假"],["1810parade","10/2018 Goddard School Halloween Parade","10/2018 戈达德托儿所万圣节游行"],
 	 	  ...
 	 	  ["2107philly","7/2021 Visiting Aunt Houzi in Pennsylvania","7/2021 宾夕法尼亚州候子阿姨家玩"],["2108vacation","8/2021 Pittsburgh and Provincetown Vacation","8/2021 匹兹堡和普罗温斯敦度假"],
                  ...
                  ["2023fallsmead","8/2023-"+strDate+" Fallsmead Elementary School","8/2023-"+strDate+" Fallsmead小学"],
                  ["2025gym","5/2025-"+strDate+" Dominique Dawes Gymnastics","5/2025-"+strDate+" 多米尼克·道斯体操馆"],
                  ["2607hhsp","7/2026 Hocking Hills State Park","7/2026 霍金山州立公园"],
...
function initAlbum(){
    ...
    this[0][i]   = ["20251031_021_Birthday","20251031_023_Birthday"];
    ...
    urltmp       = (["jR8FCTuVjEg","vDBmqKse2AU","N7PY7yS2nts","BnxZltAqAG8"])[Math.round(Math.random()*3)];
    ...
    this[0][i]   = ["2603morocco/2603morocco_21","2603morocco/2603morocco_41",["20260330","20260331"]];
    ...
    this[0][i]   = ["2607hhsp/2607hhsp_3","2607hhsp/2607hhsp_10","20260704"];
