...
function initAlbum(){
    ...
    this[0][i]    = ["2301panama/2301panama_4","20230122"];
    this[1][i++]  = (["Visiting Casco Viejo in Panama City during the "+pagelink("2301panama","vacation in Panama"),pagelink("2301panama","在巴拿马度假")+"时巴拿马城的Casco Viejo老城"])[cn_ind];
    this[0][i]    = ["2301panama/2301panama_16","20230124"];
    this[1][i++]  = (["Watching monkeys in Monkey Island during the "+pagelink("2301panama","vacation in Panama"),pagelink("2301panama","在巴拿马度假")+"时去猴岛看猴子"])[cn_ind];
    this[0][i]    = ["2301panama/2301panama_46","20230127"];
    this[1][i++]  = (["Visiting the Emberá Purú village during the "+pagelink("2301panama","vacation in Panama"),pagelink("2301panama","在巴拿马度假")+"时去访问恩贝拉部落普鲁土著村"])[cn_ind];
