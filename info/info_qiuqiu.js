...
function initAlbum(){
    ...
    this[1][i++] = "Anatomy ultrasoud at MedStar Montgomery Medical Center. Everything is fine with the baby, 6/2/2017.";
    ...
    if(window.usechinese){
        ...
        this[1][i++] = "在蒙哥马利医疗中心做解剖结构超声波检查，胎儿一切都正常，6/2/2017。";
    }
}
