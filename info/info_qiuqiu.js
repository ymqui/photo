...
var pagelist   = [["1806myrtlebeach","6/2018 Myrtle Beach, South Carolina","6/2018 南卡罗来纳州美特尔海滩度假"],["1810parade","10/2018 Goddard School Halloween Parade","10/2018 戈达德托儿所万圣节游行"],
                  ...
                  ["2002trainshow","2/2020 Model Train Show","2/2020 看火车模型展"],["2018goddard","2018-2020 Goddard School","2018-2020 戈达德托儿所"]];
...
function initAlbum(){
    ...
    this[1][i++]  = (["Visiting the gift shop of the Houston Downtown Aquarium during the "+pagelink("2001texas","vacation in Texas"),"在"+pagelink("2001texas","德克萨斯州度假")+"期间参观休斯敦水族馆，在礼品店挑了一只小老虎"])[cn_ind];
    this[0][i]    = ["2002trainshow/2002trainshow_16","20200209"];
