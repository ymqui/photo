...
//        this[1][i++] = "美国关岛";
//        this[1][i++] = "美国夏威夷州";
        this[1][i++] = "美国爱达荷州，侯子和毛毛";
        this[1][i++] = "美国伊利诺伊州，侯子和毛毛";
        this[1][i++] = "美国印第安纳州，侯子和毛毛";
        this[1][i++] = "美国爱荷华州";
        this[1][i++] = "美国堪萨斯州";
        this[1][i++] = "美国肯塔基州";
        this[1][i++] = "美国路易斯安那州";
        ...
        this[1][i++] = "美国马萨诸塞州";
        this[1][i++] = "美国密西根州";
        this[1][i++] = "美国明尼苏达州，侯子和毛毛";
        this[1][i++] = "美国密西西比州，艳梅和毛毛";
        this[1][i++] = "美国密苏里州，侯子和毛毛";
        this[1][i++] = "美国蒙大拿州，侯子和毛毛";
        this[1][i++] = "美国内布拉斯加州，侯子和毛毛";
        this[1][i++] = "美国内华达州";
        this[1][i++] = "美国新罕布什尔州";
        this[1][i++] = "美国新泽西州";
        this[1][i++] = "美国新墨西哥州";
        ...
        this[1][i++] = "美国北达科他州";
//        this[1][i++] = "美国北马里亚纳群岛";
        this[1][i++] = "美国俄亥俄州，侯子和毛毛";
        this[1][i++] = "美国俄克拉荷马州";
        this[1][i++] = "美国俄勒冈州";
        this[1][i++] = "美国宾夕法尼亚州，侯子和毛毛";
        this[1][i++] = "美国波多黎各";
        this[1][i++] = "美国罗得岛州";
        this[1][i++] = "美国南卡罗来纳州";
        this[1][i++] = "美国南达科他州，侯子和毛毛";
        this[1][i++] = "美国田纳西州";
        this[1][i++] = "美国得克萨斯州";
        this[1][i++] = "美国犹他州";
        this[1][i++] = "美国佛蒙特州";
//        this[1][i++] = "美属维尔京群岛";
        this[1][i++] = "美国弗吉尼亚州，侯子和毛毛";
        this[1][i++] = "美国华盛顿州";
        this[1][i++] = "美国西弗吉尼亚州，侯子和毛毛";
        this[1][i++] = "美国威斯康辛州";
        this[1][i++] = "美国怀俄明州，侯子和毛毛";
//        this[1][i++] = "加拿大阿尔伯塔省";
...
//        this[1][i++] = "墨西哥科利马州";
//        this[1][i++] = "墨西哥杜兰戈州";
        this[1][i++] = "墨西哥瓜纳华托州瓜纳华托城";
//        this[1][i++] = "墨西哥格雷罗州";
//        this[1][i++] = "墨西哥伊达尔戈州";
//        this[1][i++] = "墨西哥哈利斯科州";
        this[1][i++] = "墨西哥墨西哥州特奥蒂瓦坎金字塔";
        this[1][i++] = "墨西哥墨西哥城宪法广场";
//        this[1][i++] = "墨西哥米却肯州";
//        this[1][i++] = "墨西哥莫雷洛斯州";
//        this[1][i++] = "墨西哥纳亚里特州";
//        this[1][i++] = "墨西哥新莱昂州";
...
//        this[1][i++] = "墨西哥萨卡特卡斯州";
        ...
        this[1][i++] = "Alabama, United States";
        this[1][i++] = "Alaska, United States";
//        this[1][i++] = "American Samoa";
        this[1][i++] = "Arizona, United States";
        this[1][i++] = "Arkansas, United States";
        this[1][i++] = "California, United States";
        this[1][i++] = "Colorado, United States";
        this[1][i++] = "Connecticut, United States";
        this[1][i++] = "Delaware, United States";
        this[1][i++] = "District of Columbia, United States";
        this[1][i++] = "Florida, United States";
        this[1][i++] = "Georgia, United States";
//        this[1][i++] = "Guam, United States";
//        this[1][i++] = "Hawaii, United States";
        this[1][i++] = "Idaho, United States, Houzi and Maomao";
        this[1][i++] = "Illinois, United States, Houzi and Maomao";
        this[1][i++] = "Indiana, United States, Houzi and Maomao";
        this[1][i++] = "Iowa, United States";
        this[1][i++] = "Kansas, United States";
        this[1][i++] = "Kentucky, United States";
        this[1][i++] = "Louisiana, United States";
        this[1][i++] = "Maine, United States";
        this[1][i++] = "Maryland, United States";
        this[1][i++] = "Massachusetts, United States";
        this[1][i++] = "Michigan, United States";
        this[1][i++] = "Minnesota, United States, Houzi and Maomao";
        this[1][i++] = "Mississippi, United States, Yanmei and Maomao";
        this[1][i++] = "Missouri, United States, Houzi and Maomao";
        this[1][i++] = "Montana, United States, Houzi and Maomao";
        this[1][i++] = "Nebraska, United States, Houzi and Maomao";
        this[1][i++] = "Nevada, United States";
        this[1][i++] = "New Hampshire, United States";
        this[1][i++] = "New Jersey, United States";
        this[1][i++] = "New Mexico, United States";
        this[1][i++] = "New York, United States";
        this[1][i++] = "North Carolina, United States";
        this[1][i++] = "North Dakota, United States";
//        this[1][i++] = "Northern Mariana Islands, United States";
        this[1][i++] = "Ohio, United States, Houzi and Maomao";
        this[1][i++] = "Oklahoma, United States";
        this[1][i++] = "Oregon, United States";
        this[1][i++] = "Pennsylvania, United States, Houzi and Maomao";
        this[1][i++] = "Puerto Rico, United States";
        this[1][i++] = "Rhode Island, United States";
        this[1][i++] = "South Carolina, United States";
        this[1][i++] = "South Dakota, United States, Houzi and Maomao";
        this[1][i++] = "Tennessee, United States";
        this[1][i++] = "Texas, United States";
        this[1][i++] = "Utah, United States";
        this[1][i++] = "Vermont, United States";
//        this[1][i++] = "Virgin Islands, United States";
        this[1][i++] = "Virginia, United States, Houzi and Maomao";
        this[1][i++] = "Washington, United States";
        this[1][i++] = "West Virginia, United States, Houzi and Maomao";
        this[1][i++] = "Wisconsin, United States";
        this[1][i++] = "Wyoming, United States, Houzi and Maomao";
...
//        this[1][i++] = "Durango, Mexico";
        this[1][i++] = "Guanajuato City, Guanajuato, Mexico";
//        this[1][i++] = "Guerrero, Mexico";
//        this[1][i++] = "Hidalgo, Mexico";
//        this[1][i++] = "Jalisco, Mexico";
        this[1][i++] = "Teotihuacan, México, Mexico";
        this[1][i++] = "Zocalo, Mexico City, Mexico";
