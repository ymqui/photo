...
//    this[0][i++] = "";
    i = 0;
    if(window.usechinese){
        this[1][i++] = "美国阿拉巴马州，2011-12-26。";
        this[1][i++] = "美国阿拉斯加州，2013-07-12。";
//        this[1][i++] = "美属萨摩亚，。";
        this[1][i++] = "美国亚利桑那州，2012-12-20。";
        this[1][i++] = "美国阿肯色州，2013-12-22。";
        this[1][i++] = "美国加利福尼亚州，2012-12-25。";
        this[1][i++] = "美国科罗拉多州，2012-12-29。";
        this[1][i++] = "美国康涅狄格州，2014-12-25。";
        this[1][i++] = "美国特拉华州，2012-01-27。";
        this[1][i++] = "美国哥伦比亚特区，2011-12-03。";
        this[1][i++] = "美国佛罗里达州，2011-12-26。";
        this[1][i++] = "美国乔治亚州，2011-12-30。";
//        this[1][i++] = "美国关岛，。";
//        this[1][i++] = "美国夏威夷州，。";
        this[1][i++] = "美国爱达荷州，侯子和毛毛，2011-06-29。";
        this[1][i++] = "美国伊利诺伊州，侯子和毛毛，2011-06-24。";
        this[1][i++] = "美国印第安纳州，侯子和毛毛，2011-06-24。";
        this[1][i++] = "美国爱荷华州，2014-07-03。";
        this[1][i++] = "美国堪萨斯州，2013-12-21。";
        this[1][i++] = "美国肯塔基州，2012-08-15。";
        this[1][i++] = "美国路易斯安那州，2011-12-23。";
        this[1][i++] = "美国缅因州，2013-10-05。";
        this[1][i++] = "美国马里兰州，2011-10-08。";
        this[1][i++] = "美国马萨诸塞州，2011-09-03。";
        this[1][i++] = "美国密西根州，2014-07-05。";
        this[1][i++] = "美国明尼苏达州，侯子和毛毛，2011-07-02。";
        this[1][i++] = "美国密西西比州，艳梅和毛毛，2011-12-22。";
        this[1][i++] = "美国密苏里州，侯子和毛毛，2011-06-25。";
        this[1][i++] = "美国蒙大拿州，侯子和毛毛，2011-06-29。";
        this[1][i++] = "美国内布拉斯加州，侯子和毛毛，2011-06-25。";
        this[1][i++] = "美国内华达州，2012-12-20。";
        this[1][i++] = "美国新罕布什尔州，2013-10-05。";
        this[1][i++] = "美国新泽西州，2012-01-27。";
        this[1][i++] = "美国新墨西哥州，2012-12-29。";
        this[1][i++] = "美国纽约州，2011-09-03。";
        this[1][i++] = "美国北卡罗来纳州，2011-12-31。";
        this[1][i++] = "美国北达科他州，2014-07-04。";
//        this[1][i++] = "美国北马里亚纳群岛，。";
        this[1][i++] = "美国俄亥俄州，侯子和毛毛，2011-06-24。";
        this[1][i++] = "美国俄克拉荷马州，2013-12-22。";
        this[1][i++] = "美国俄勒冈州，2015-07-10。";
        this[1][i++] = "美国宾夕法尼亚州，侯子和毛毛，2011-07-03。";
        this[1][i++] = "美国波多黎各，2015-01-07。";
        this[1][i++] = "美国罗得岛州，2011-09-03。";
        this[1][i++] = "美国南卡罗来纳州，2011-12-30。";
        this[1][i++] = "美国南达科他州，侯子和毛毛，2011-07-01。";
        this[1][i++] = "美国田纳西州，2011-12-21。";
        this[1][i++] = "美国得克萨斯州，2013-12-24。";
        this[1][i++] = "美国犹他州，2012-12-30。";
        this[1][i++] = "美国佛蒙特州，2013-10-06。";
//        this[1][i++] = "美属维尔京群岛，。";
        this[1][i++] = "美国弗吉尼亚州，侯子和毛毛，2011-07-04。";
        this[1][i++] = "美国华盛顿州，2015-07-09。";
        this[1][i++] = "美国西弗吉尼亚州，侯子和毛毛，2011-06-24。";
        this[1][i++] = "美国威斯康辛州，2014-07-04。";
        this[1][i++] = "美国怀俄明州，侯子和毛毛，2011-06-26。";
//        this[1][i++] = "加拿大阿尔伯塔省，。";
...
//        this[1][i++] = "加拿大西北地区，。";
//        this[1][i++] = "加拿大新斯科舍省省，。";
        this[1][i++] = "加拿大安大略省，2017-09-01。";
//        this[1][i++] = "加拿大爱德华王子岛省，。";
        this[1][i++] = "加拿大魁北克省，2016-09-15。";
//        this[1][i++] = "加拿大萨斯喀彻温省，。";
//        this[1][i++] = "加拿大努纳武特地区，。";
        this[1][i++] = "加拿大育空地区，2013-07-12。";
...
//        this[1][i++] = "墨西哥科利马州，。";
//        this[1][i++] = "墨西哥杜兰戈州，。";
        this[1][i++] = "墨西哥瓜纳华托州瓜纳华托城，2019-05-13。";
//        this[1][i++] = "墨西哥格雷罗州，。";
//        this[1][i++] = "墨西哥伊达尔戈州，。";
//        this[1][i++] = "墨西哥哈利斯科州，。";
        this[1][i++] = "墨西哥墨西哥州特奥蒂瓦坎金字塔，2019-05-11。";
        this[1][i++] = "墨西哥墨西哥城宪法广场，2019-05-16。";
//        this[1][i++] = "墨西哥米却肯州，。";
//        this[1][i++] = "墨西哥莫雷洛斯州，。";
//        this[1][i++] = "墨西哥纳亚里特州，。";
//        this[1][i++] = "墨西哥新莱昂州，。";
...
//        this[1][i++] = "墨西哥普埃布拉州，。";
//        this[1][i++] = "墨西哥克雷塔罗州，。";
        this[1][i++] = "墨西哥金塔纳罗奥州科巴玛雅遗址，2010-12-15。";
...
//        this[1][i++] = "Querétaro, Mexico, .";
        this[1][i++] = "Coba Ruins, Quintana Roo, Mexico, 12/15/2010.";
