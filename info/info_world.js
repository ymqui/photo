...
function initAlbum(){
    ...
    this[1][i++]  = pagelink("1812costarica",(["Arenal Volcano, Alajuela Province, "+coltext("Costa Rica"),coltext("哥斯达黎加")+"阿拉胡埃拉省阿雷纳火山"])[cn_ind]);
    this[0][i]    = "20190420_USA";
    this[1][i++]  = pagelink("1904dcmuseum",(["National Mall, Washington DC, "+coltext("United States"),coltext("美国")+"华盛顿特区国家广场"])[cn_ind]);
    this[0][i]    = "20190511_Mexico";
    this[1][i++]  = pagelink("1905mexico",(["Teotihucan Pyramid of the Sun, "+coltext("Mexico"),coltext("墨西哥")+"特奥蒂瓦坎古城太阳金字塔"])[cn_ind]);
    this[0][i]    = "20220826_Canada";
    this[1][i++]  = pagelink("2208canada",(["Niagara Falls, Ontario, "+coltext("Canada"),coltext("加拿大")+"安大略省尼亚加拉大瀑布"])[cn_ind]);
