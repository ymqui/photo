<!--
  ...
  locs["mdbhrp"] = ["Black Hill Regional Park","Maryland","黑山公园","马里兰州","http://www.montgomeryparks.org/parks-and-trails/black-hill-regional-park/"];
  locs["mdbmnt"] = ["Blue Mash Nature Trail","Maryland","蓝沼自然小径","马里兰州","http://old.montgomeryparks.org/PPSD/ParkTrails/trails_MAPS/blue_mash.shtm"];
  locs["mdbrgd"] = ["Brookside Garden","Wheaton, Maryland","惠顿溪边花园","马里兰州","http://www.montgomeryparks.org/parks-and-trails/brookside-gardens/"];
  ...
  locs["scjwwc"] = ["James Webb Wildlife Center","South Carolina","詹姆斯·韦伯野生动物中心","南卡罗来纳州","https://www.carolinabirdclub.org/sites/SC/webbcenter.html"];
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Tufted Duck","凤头潜鸭","Aythya fuligula",[m_id("")],["mdbhrp","9/2015"],wikiurl("Tufted duck"),32925);
  birds[j++] = new myBird("USA","17-02-04T14:16","ANATIDAE","Greater Scaup","斑背潜鸭","Aythya marila",[m_id("20170204_017_GreaterScaup(F)")],["arbitr","2/2017","Female, Greenbelt Lake, Maryland","雌性，格林贝尔特湖，马里兰州"],32982);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","SPHENISC","African Penguin","非洲企鹅","Spheniscus demersus",[m_id("")],["mdbhrp","9/2015"],1448601);
  birds[j++] = new myBird("USA","16-06-18T09:35","OCEANITI","Wilson's Storm-Petrel","黄蹼洋海燕","Oceanites oceanicus",[m_id("20160618_076_Wilson'sStorm-Petrel")],["arbitr","6/2016","Cape May-Lewes Ferry, Delaware/New Jersey","五月岬-刘易斯轮渡，特拉华州/新泽西州"],cornellurl("wispet",true),269388);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","THRESKIO","White-faced Ibis","白脸彩鹮","Plegadis chihi",[m_id("")],["arbitr","6/2017","Deal Island Wildlife Management Area, Maryland","迪尔岛野生动物管理区，马里兰州"],4890250);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Franklin's Gull","弗氏鸥","Leucophaeus pipixcan",[m_id("")],["mdbhrp","9/2015"],4822199);
  ...
  birds[j++] = new myBird("USA","05-11-26T09:57","LARIDAE ","Ring-billed Gull","环嘴鸥","Larus delawarensis",m_id(["20151031_116_Ring-billedGull","20150321_037_Ring-billedGull(1W)"]),["mdocin","10/2015","arbitr","3/2015","1st winter, Southwest Area Park, Baltimore, Maryland","一齡冬羽，巴尔的摩西南地区公园，马里兰州"],4822011);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","PICIDAE ","Great Spotted Woodpecker","大斑啄木鸟","Dendrocopos major",[p_id("1601china",)],["cnbjjp","1/2016"],15618);
  birds[j++] = new myBird("USA","08-12-13T15:36","PICIDAE ","Northern Flicker","北扑翅鴷","Colaptes auratus",m_id(["20171022_124_NorthernFlicker(M)","20160625_085_NorthernFlicker(F)"]),["mdlbrp","10/2017","Male, yellow-shafted","黄色雄性","nyjbwr","6/2016","Female, yellow-shafted","黄色雌性"],3945688);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","PSITTACI","Scarlet Macaw","绯红金刚鹦鹉","Ara macao",["0504zoo/0504zoo__23"],["natzo","4/2005"],cornellurl("scamac1",true),139631);
  birds[j++] = new myBird("USA","16-06-12T08:14","PSITTACI","Blue-crowned Parakeet","蓝冠鹦哥","Thectocercus acuticaudatus",[p_id("1606florida",24)],["arbitr","6/2016","South Beach, Miami, Florida","迈阿密南滩，佛罗里达州"],cornellurl("bucpar",true),46205);
//birds[j++] = new myBird("USA","17-00-00T00:00","PSITTACI","Mitred Parakeet","米特雷锥尾鹦鹉","Psittacara mitratus",[m_id("")],["arbitr","6/2016","Lincoln Road Mall, Miami, Florida","迈阿密林肯路购物中心，佛罗里达州"],cornellurl("mitpar",true),4884817);
  birds[j++] = new myBird("USA","16-06-12T07:14","PSITTACI","Red-masked Parakeet","红头鹦鹉","Psittacara erythrogenys",p_id("1606florida",[22,21]),["arbitr","6/2016","Lincoln Road Mall, Miami, Florida","迈阿密林肯路购物中心，佛罗里达州"],cornellurl("rempar",true),1257150);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","UROCYNCH","Przevalski's Finch","朱鹀","Urocynchramus pylzowi",[m_id("")],["mdbhrp","9/2015"],33042);
  ...
  birds[j++] = new myBird("USA","17-02-11T11:47","FRINGILL","Red Crossbill","红交嘴雀","Loxia curvirostra",[m_id("20170211_020_RedCrossbill")],["arbitr","2/2017","Male red, female yellow-green, Owl Creek Park, Schuylkill County, Pennsylvania","雄性带红色，雌性黄绿色，斯古吉尔郡鸮河公园，宾夕法尼亚州"],71619);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Scott's Oriole","斯氏拟鹂","Icterus parisorum",[m_id("")],["mdbhrp","9/2015"],4707365);
  birds[j++] = new myBird("USA","15-01-03T13:57","ICTERIDA","Venezuelan Troupial","委内瑞拉拟鹂","Icterus icterus",[p_id("1501prbirding",20)],["arbitr","1/2015","Guanica Dry Forest, Puerto Rico","瓜尼卡干燥森林，波多黎各"],cornellurl("ventro1",true),3179670);
