<!--
  ...
  var cnt_nm = {usa:["USA","美国"], chn:["China","中国"], ata:["Antarctica","南极洲"], blz:["Belize","伯利兹"], bra:["Brazil","巴西"], can:["Canada","加拿大"], cri:["Costa Rica","哥斯达黎加"], fra:["France","法国"], jpn:["Japan","日本"], per:["Peru","秘鲁"], non:["",""]};
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Black-bellied Whistling-Duck","黑腹树鸭","Dendrocygna autumnalis",[m_id("")],["mdbhrp","9/2015"],3320156);
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Fulvous Whistling-Duck","茶色树鸭","Dendrocygna bicolor",[m_id("")],["mdbhrp","9/2015"],1176074);
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Pink-footed Goose","粉脚雁","Anser brachyrhynchus",[m_id("")],["mdbhrp","9/2015"],"http://www.audubon.org/field-guide/bird/pink-footed-goose",3192563);
  ...
  birds[j++] = new myBird("USA","16-12-12T08:10","ANATIDAE","Ross's Goose","细嘴雁","Chen rossii",[m_id("20161212_140_Ross'sGoose")],["arbitr","12/2016","Whittier Lake Park, Frederick, Maryland, USA","弗雷德里克市惠蒂尔湖公园，美国马里兰州"],3203046);
  ...
  birds[j++] = new myBird("USA","15-12-31T08:48","ANATIDAE","Cackling Goose","小美洲黑雁","Branta hutchinsii",[m_id("20151231_140_CacklingGoose")],["arbitr","12/2015","2nd from front in the center (with the smallest bill), River Bend Park, Frederick, Maryland, USA","中间第二只(嘴最小的)，弗雷德里克市河湾公园，美国马里兰州"],12989977);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","ANATIDAE","Mandarin Duck","鸳鸯","yuan1 yang1","Aix galericulata",["0504zoo/0504zoo__13"],["natzo","4/2005"],wikiurl("Mandarin Duck"),17774);
  ...
  birds[j++] = new myBird("USA","16-03-13T09:30","ANATIDAE","Eurasian Wigeon","赤颈鸭","Anas penelope",[m_id("20160313_020_EurasianWigeon(M)")],["arbitr","3/2016","Male, Trout Run WWTP, Garrett County, Maryland, USA","雄性，加勒特郡鳟鱼溪废水处理厂，美国马里兰州"],179821);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Tufted Duck","凤头潜鸭","Aythya fuligula",[m_id("")],["mdbhrp","9/2015"],wikiurl("Tufted duck"),32925);
  birds[j++] = new myBird("USA","17-02-04T14:16","ANATIDAE","Greater Scaup","斑背潜鸭","Aythya marila",[m_id("20170204_017_GreaterScaup(F)")],["arbitr","2/2017","Female, Greenbelt Lake, Maryland, USA","雌性，格林贝尔特湖，美国马里兰州"],32982);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ANATIDAE","Barrow's Goldeneye","巴氏鹊鸭","Bucephala islandica",[m_id("")],["mdbhrp","9/2015"],3249097);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CRACIDAE","Plain Chachalaca","纯色小冠雉","Ortalis vetula",[m_id("")],["mdbhrp","9/2015"],4973094);
//birds[j++] = new myBird("   ","17-00-00T00:00","NUMIDIDA","Helmeted Guineafowl","珠鸡","Numida meleagris",[m_id("")],["mdbhrp","9/2015"],275982);
//birds[j++] = new myBird("USA","17-00-00T00:00","ODONTOPH","Mountain Quail","山翎鹑","Oreortyx pictus",[m_id("")],["mdbhrp","9/2015"],3808970);
//birds[j++] = new myBird("USA","17-00-00T00:00","ODONTOPH","Scaled Quail","鳞斑鹑","Callipepla squamata",[m_id("")],["mdbhrp","9/2015"],3807792);
//birds[j++] = new myBird("USA","17-00-00T00:00","ODONTOPH","California Quail","珠颈翎鹑","Callipepla californica",[m_id("")],["mdbhrp","9/2015"],3614642);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ODONTOPH","Northern Bobwhite","山齿鹑","Colinus virginianus",[p_id("1412mckee-beshers",6)],["mdmwma","8/2014","Male"],1503283);
//birds[j++] = new myBird("USA","17-00-00T00:00","ODONTOPH","Montezuma Quail","彩鹑","Cyrtonyx montezumae",[m_id("")],["mdbhrp","9/2015"],3807919);
//birds[j++] = new myBird("USA","17-00-00T00:00","PHASIANI","Chukar","石鸡","Alectoris chukar",[p_id("1412mckee-beshers",6)],["mdmwma","8/2014","A released bird","一只释放鸟"],"石鸡");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","GAVIIDAE","Pacific Loon","太平洋潜鸟","Gavia pacifica",[m_id("")],["mdbhrp","9/2015"],855436);
  birds[j++] = new myBird("USA","15-03-08T10:08","GAVIIDAE","Common Loon","普通潜鸟","Gavia immer",[p_id("1503barnegat",16),m_id("20151126_137_CommonLoon(WP)"),p_id("1503barnegat",15)],["njblsp","3/2015","mdocin","11/2015","Winter plumage","njblsp","3/2015","Immature"],855440);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","SPHENISC","African Penguin","非洲企鹅","Spheniscus demersus",[m_id("")],["mdbhrp","9/2015"],1448601);
  birds[j++] = new myBird("USA","16-06-18T09:35","OCEANITI","Wilson's Storm-Petrel","黄蹼洋海燕","Oceanites oceanicus",[m_id("20160618_076_Wilson'sStorm-Petrel")],["arbitr","6/2016","Cape May-Lewes Ferry, Delaware/New Jersey, USA","五月岬-刘易斯轮渡，美国特拉华州/新泽西州"],cornellurl("wispet",true),269388);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PROCELLA","Sooty shearwater","灰鹱","Puffinus griseus",[m_id("")],["mdbhrp","9/2015"],855476);
//birds[j++] = new myBird("USA","17-00-00T00:00","PROCELLA","Northern Fulmar","暴风鹱","Fulmarus glacialis",[m_id("")],["mdbhrp","9/2015"],855455);
//birds[j++] = new myBird("   ","17-00-00T00:00","PROCELLA","Common Diving Petrel","鹈燕","Pelecanoides urinatrix",[m_id("")],["mdbhrp","9/2015"],4982791);
//birds[j++] = new myBird("USA","17-00-00T00:00","PODICIPE","Least Grebe","侏䴙䴘","Tachybaptus dominicus",[m_id("")],["txbbnp","12/2013"],891735);
  ...
  birds[j++] = new myBird("USA","16-12-31T09:49","PODICIPE","Red-necked Grebe","赤颈䴙䴘","Podiceps grisegena",[m_id("20161231_143_Red-neckedGrebe(WP)")],["mdloch","12/2016","Winter plumage"],417750);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PODICIPE","Clark's Grebe","克氏䴙䴘","Aechmophorus clarkii",[m_id("")],["txbbnp","12/2013"],2546204);
//birds[j++] = new myBird("USA","17-00-00T00:00","PHOENICO","American Flamingo","美洲红鹳","Phoenicopterus ruber",["0504zoo/0504zoo__14"],["natzo","4/2005"],cornellurl("grefla2",true),10062545);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","THRESKIO","White-faced Ibis","白脸彩鹮","Plegadis chihi",[m_id("")],["arbitr","6/2017","Deal Island Wildlife Management Area, Maryland, USA","迪尔岛野生动物管理区，美国马里兰州"],4890250);
  ...
  birds[j++] = new myBird("USA","15-04-26T14:02","ARDEIDAE","American Bittern","美洲麻鳽","Botaurus lentiginosus",[m_id("20150426_064_AmericanBittern"),p_id("1609vtcanbirding",18),p_id("1609vtcanbirding",19)],["arbitr","4/2015","North Point State Park, Maryland, USA","北点州立公园，美国马里兰州","cactnw","9/2016","cactnw","9/2016"],2764197);
//birds[j++] = new myBird("USA","17-00-00T00:00","ARDEIDAE","Least Bittern","姬苇鳽","Ixobrychus exilis",[m_id("")],["ohment","5/2017"],2783545);
  birds[j++] = new myBird("USA","06-05-06T17:42","ARDEIDAE","Black-crowned Night-Heron","夜鹭","Nycticorax nycticorax",m_id(["20160625_081_Black-crownedNight-Heron","20170827_096_Black-cronwedNight-Heron(I)"]),["nyjbwr","6/2016","mdcorl","8/2017","Immature"],[158941,18625898]);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ARDEIDAE","Reddish Egret","棕颈鹭","Egretta rufescens",[m_id("")],["mdocin","10/2015","Immature"],2772656);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PHALACRO","Neotropic Cormorant","美洲鸬鹚","Phalacrocorax brasilianus",[m_id("")],["arbitr","7/2017","North Beach, Maryland, USA","北海滩镇，美国马里兰州"],2554751);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CATHARTI","California Condor","加州神鹫","Gymnogyps californianus",[m_id("")],["mdbhrp","9/2015"],2175658);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ACCIPITR","Swallow-tailed Kite","燕尾鸢","Elanoides forficatus",[m_id("")],["flevnp","6/2016"],3598686);
//birds[j++] = new myBird("USA","17-00-00T00:00","ACCIPITR","White-tailed Kite","白尾鸢","Elanus leucurus",[m_id("")],["flevnp","9/2015"],3565553);
  ...
  birds[j++] = new myBird("USA","05-10-30T09:34","ACCIPITR","Bald Eagle","白头海雕","Haliaeetus leucocephalus",m_id(["20170225_025_BaldEagle","20170108_005_BaldEagle(I)"]),["mdswhf","2/2017","mdmapp","1/2017","Immature"],296826);
  birds[j++] = new myBird("USA","13-12-29T15:19","ACCIPITR","Northern Harrier","北鹞","Circus cyaneus",[p_id("1612savannah",4),m_id("20161204_132_NorthernHarrier(I)")],["scsnwr","12/2016","Female","nyjbsp","12/2016","Immature"],32735);
  birds[j++] = new myBird("USA","11-10-08T15:34","ACCIPITR","Sharp-shinned Hawk","纹腹鹰","Accipiter striatus",m_id(sas(["20150215_013","20150215_014","20161106_117"],"_Sharp-shinnedHawk",["","","(I)"])),["mdcrvp","2/2015","mdcrvp","2/2015","mdcrvp","11/2016","Immature"],11614189);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ACCIPITR","Golden Eagle","金雕","Aquila chrysaetos",[m_id("")],["arbitr","2/2017","Immature, Pickering Creek Audubon Center, Talbot County, Maryland, USA","未成年，塔尔博特郡皮克林河奥杜邦鸟类中心，美国马里兰州"],14344);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","RALLIDAE","King Rail","王秧鸡","Rallus elegans",[m_id("")],["arbitr","5/2017","Wooton's Landing Park, Anne Arundel County, Maryland, USA","安妮阿伦德尔郡伍顿登陆公园，美国马里兰州"],2506673);
  birds[j++] = new myBird("USA","17-05-28T06:24","RALLIDAE","Virginia Rail","弗吉尼亚秧鸡","Rallus limicola",p_id("1705ohio",[8,6]),["arbitr","5/2017","Mentor Marsh State Nature Perserve, Ohio, USA","门托沼泽州立自然保护区，美国俄亥俄州"],2444046);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","PSOPHIID","Grey-winged Trumpeter","灰翅喇叭声鹤","Psophia crepitans",[m_id("")],["mdbhrp","9/2015"],4977152);
  birds[j++] = new myBird("USA","15-02-08T08:24","GRUIDAE ","Sandhill Crane","沙丘鹤","Grus canadensis",m_id(["20150208_004_SandhillCrane","20150208_006_SandhillCrane"]),["arbitr","2/2015","Bradshaw Road, Kingsville, Maryland, USA","金斯维尔镇布拉德肖路，美国马里兰州"],90234);
//birds[j++] = new myBird("USA","17-00-00T00:00","GRUIDAE ","Whooping Crane","美洲鹤","Grus americana",[m_id("")],["mdbhrp","9/2015"],586766);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","GRUIDAE ","Red-crowned Crane","丹顶鹤","Grus japonensis",["0504zoo/0504zoo__8"],["natzo","4/2005"],wikiurl("Red-crowned Crane"),4290);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","IBIDORHY","Ibisbill","鹮嘴鹬","Ibidorhyncha struthersii",[m_id("")],["mdbhrp","9/2015"],32783);
  ...
  birds[j++] = new myBird("USA","15-05-17T12:01","CHARADRI","Black-bellied Plover","灰斑鸻","Pluvialis squatarola",[p_id("1505bombayhook",16),p_id("1509charleston",11),m_id("20161204_131_Black-belliedPlover(WP)")],["debnwr","5/2015","Male","scpitt","9/2015","Female","nyjbsp","12/2016","Winter plumage"],276118);
//birds[j++] = new myBird("USA","17-00-00T00:00","CHARADRI","American Golden-Plover","美洲金鸻","Pluvialis dominica",[m_id("")],["mdbhrp","9/2015"],301063);
//birds[j++] = new myBird("USA","17-00-00T00:00","CHARADRI","Snowy Plover","雪鸻","Charadrius nivosus",[m_id("")],["mdbhrp","9/2015"],7966097);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","THINOCOR","Rufous-bellied Seedsnipe","棕腹籽鹬","Attagis gayi",[m_id("")],["mdbhrp","9/2015"],697583);
  birds[j++] = new myBird("USA","06-04-23T17:28","SCOLOPAC","Spotted Sandpiper","斑腹矶鹬","Actitis macularius",[m_id("20170806_086_SpottedSandpiper")],["arbitr","8/2017","North Beach, Calvert County, Maryland, USA","卡尔弗特郡北海滩，美国马里兰州"],13231604);
  birds[j++] = new myBird("USA","06-05-06T16:31","SCOLOPAC","Solitary Sandpiper","褐腰草鹬","Tringa solitaria",[m_id("20170423_032_SolitarySandpiper")],["arbitr","4/2017","Schoolhouse Pond, Prince George's County, Maryland, USA","乔治王子郡校舍池塘，美国马里兰州"],13229089);
  ...
  birds[j++] = new myBird("USA","14-08-30T17:42","SCOLOPAC","Lesser Yellowlegs","小黄脚鹬","Tringa flavipes",[m_id("20170924_108_LesserYellowlegs")],["arbitr","9/2017","Shiloh Church Road Turf Farm, Dorchester County, Maryland, USA","多切斯特郡夏伊洛教堂路草皮农场，美国马里兰州"],300494);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","SCOLOPAC","Hudsonian Godwit","棕塍鹬","Limosa haemastica",[p_id("1509charleston",8)],["scpitt","9/2015"],"棕塍鹬");
  ...
  birds[j++] = new myBird("USA","15-09-07T07:44","SCOLOPAC","Sanderling","三趾滨鹬","Calidris alba",[p_id("1612savannah",15),p_id("1509charleston",17)],["gatybe","12/2016","Winter plumage","arbitr","9/2015","Juvenile, Fort Moultrie, South Carolina, USA","未成年，莫尔特里堡，美国南卡罗来纳州"],300486);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","SCOLOPAC","Pectoral Sandpiper","斑胸滨鹬","Calidris melanotos",[m_id("")],["arbitr","5/2017","Schoolhouse Pond, Prince George's County, Maryland, USA","乔治王子郡校舍池塘，美国马里兰州"],836706);
  ...
  birds[j++] = new myBird("USA","15-05-17T10:14","SCOLOPAC","Dunlin","黑腹滨鹬","Calidris alpina",m_id(["20170520_061_Dunlin","20151114_122_Dunlin(WP)"]),["debowb","5/2017","arbitr","11/2015","Winter plumage, Assateague Island National Seashore, Maryland, USA","冬羽，阿萨蒂格岛国家海岸，美国马里兰州"],254061);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","SCOLOPAC","Ruff","流苏鹬","Philomachus pugnax",[m_id("")],["arbitr","4/2017","Augustine Wildlife Area-Port Penn Impoundments, Delaware, USA","奥古斯丁野生动物保护区，美国特拉华州"],wikiurl("Ruff"),39676);
  ...
  birds[j++] = new myBird("USA","16-01-30T09:03","SCOLOPAC","Wilson's Snipe","美洲沙锥","Gallinago delicata",m_id(sas("20160130_00",["1","2"],"_Wilson'sSnipe")),["arbitr","1/2016","Glade Road, Frederick County, Maryland, USA","弗雷德里克郡格雷德路，美国马里兰州"],3193898);
  birds[j++] = new myBird("USA","16-02-27T18:20","SCOLOPAC","American Woodcock","小丘鹬","Scolopax minor",[m_id("20160227_018_AmericanWoodcock")],["arbitr","2/2016","Patuxent River State Park at Hipsley Mill Road, Maryland, USA","帕塔克森特河州立公园，美国马里兰州"],1154742);
//birds[j++] = new myBird("USA","17-00-00T00:00","SCOLOPAC","Wilson's Phalarope","赤斑瓣蹼鹬","Phalaropus tricolor",[m_id("")],["mdbhrp","9/2015"],697557);
//birds[j++] = new myBird("USA","17-00-00T00:00","SCOLOPAC","Red-necked Phalarope","红颈瓣蹼鹬","Phalaropus lobatus",[m_id("")],["mdbhrp","9/2015"],cornellurl("renpha",true),"红颈瓣蹼鹬");
...
//birds[j++] = new myBird("   ","17-00-00T00:00","GLAREOLI","Collared Pratincole","领燕鸻","Glareola pratincola",[m_id("")],["mdbhrp","9/2015"],304194);
  ...
  birds[j++] = new myBird("USA","17-09-09T08:52","LARIDAE ","Sabine's Gull","叉尾鸥","Xema sabini",[m_id("20170909_099_Sabine'sGull")],["mdcocn","9/2017","Immature","未成年"," at Sycamore Landing","悬铃木码头"],"叉尾鸥");
  birds[j++] = new myBird("USA","15-03-21T15:08","LARIDAE ","Bonaparte's Gull","博氏鸥","Chroicocephalus philadelphia",m_id(["20150321_045_Bonaparte'sGull(W)","20151126_136_Bonaparte'sGull(WP)"]),["arbitr","3/2015","Winter plumage, Lapidum, Maryland, USA","冬羽，萨斯奎哈纳州立公园，美国马里兰州","mdocin","11/2015","Winter plumage"],4825408);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Little Gull","小鸥","Hydrocoloeus minutus",[m_id("")],["mdloch","11/2015","",""," at Paper Mill Flats","造纸厂路平滩"],129400);
  birds[j++] = new myBird("USA","06-07-16T14:43","LARIDAE ","Laughing Gull","笑鸥","Larus atricilla",[p_id("0607outerbanks",28),p_id("1505capemay",3),m_id("20161105_112_LaughingGull(WP)")],["ncoutb","7/2006","njcmsp","5/2015","mdocci","11/2016","Winter plumage"],1607122);
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Franklin's Gull","弗氏鸥","Leucophaeus pipixcan",[m_id("")],["mdbhrp","9/2015"],4822199);
  ...
  birds[j++] = new myBird("USA","05-11-26T09:57","LARIDAE ","Ring-billed Gull","环嘴鸥","Larus delawarensis",m_id(["20151031_116_Ring-billedGull","20150321_037_Ring-billedGull(1W)"]),["mdocin","10/2015","arbitr","3/2015","1st winter, Southwest Area Park, Baltimore, Maryland, USA","一齡冬羽，巴尔的摩西南地区公园，美国马里兰州"],4822011);
  ...
  birds[j++] = new myBird("USA","17-02-04T11:04","LARIDAE ","Iceland Gull","冰岛鸥","Larus glaucoides",[m_id("20170204_016_IcelandGull(1W)")],["mdmapp","2/2017","1st winter","一龄冬羽"],-9019);
  birds[j++] = new myBird("USA","15-10-04T14:12","LARIDAE ","Lesser Black-backed Gull","小黑背鸥","Larus fuscus",[m_id("20151004_104_LesserBlack-backedGull")],["mdocci","10/2015","With "+b_link("Ring-billed Gull","s")+" (front) and "+b_link("Black Skimmer","s")+" (back)","前面是"+b_link("环嘴鸥")+"，后面是"+b_link("黑剪嘴鸥")],14813315);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Glaucous Gull","北极鸥","Larus hyperboreus",[m_id("")],["mdbhrp","9/2015"],82036);
  birds[j++] = new myBird("USA","15-03-08T09:17","LARIDAE ","Great Black-backed Gull","大黑背鸥","Larus marinus",[p_id("1503barnegat",10),m_id("20151031_115_GreatBlack-backedGull(1W)")],["njblsp","3/2015","mdocin","10/2015","1st winter","一龄冬羽"],1587200);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Gull-billed Tern","鸥嘴噪鸥","Gelochelidon nilotica",[m_id("")],["njblsp","3/2015"],853324);
  birds[j++] = new myBird("USA","15-07-10T10:09","LARIDAE ","Caspian Tern","红嘴巨鸥","Hydroprogne caspia",m_id(sas("20150808_08",["9","8"],"_CaspianTern")),["arbitr","8/2015","Dyke Marsh Wildlife Preserve, Virginia, USA","黛克湿地野生动物保护区，美国弗吉尼亚州"],853326);
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Black Tern","黑浮鸥","Chlidonias niger",[m_id("")],["vadmwp","8/2015"],279151);
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Roseate Tern","粉红燕鸥","Sterna dougallii",[m_id("")],["mdbhrp","9/2015"],100023);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Arctic Tern","北极燕鸥","Sterna paradisaea",[m_id("")],["mdbhrp","9/2015"],90251);
  ...
  birds[j++] = new myBird("USA","15-01-08T09:29","LARIDAE ","Royal Tern","橙嘴凤头燕鸥","Thalasseus maximus",[m_id("20151031_117_RoyalTern(W)"),p_id("1501prbirding",41),p_id("1501prbirding",42)],["mdocin","10/2015","Winter plumage","prosan","1/2015"],4821361);
//birds[j++] = new myBird("USA","17-00-00T00:00","LARIDAE ","Sandwich Tern","白嘴端凤头燕鸥","Thalasseus sandvicensis",[m_id("")],["njblsp","3/2015"],4821400);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","STERCORA","Parasitic Jaeger","短尾贼鸥","Stercorarius parasiticus",[m_id("")],["mdocin","10/2015"],cornellurl("parjae",true),853265);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ALCIDAE ","Horned Puffin","角海鹦","Fratercula corniculata",["1505puffin/"],["meeeri","5/2015"],4821571);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","COLUMBID","Band-tailed Pigeon","斑尾鸽","Patagioenas fasciata",[m_id("")],["mdbhrp","9/2015"],3755692);
  ...
  birds[j++] = new myBird("USA","15-07-12T10:32","COLUMBID","Eurasian Collared-Dove","灰斑鸠","Streptopelia decaocto",[p_id("1606florida",25)],["arbitr","6/2016","South Beach, Miami, Florida, USA","迈阿密南滩，美国佛罗里达州"],39688);
  ...
  birds[j++] = new myBird("USA","15-01-08T10:50","COLUMBID","Zenaida Dove","鸣哀鸽","Zenaida aurita",[p_id("1501prbirding",45)],["prosan","1/2015"],cornellurl("zendov",true),3806186);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CUCULIDA","Black-billed Cuckoo","黑嘴美洲鹃","Coccyzus erythropthalmus",[m_id("")],["nyjbwr","5/2016"],4888584);
  ...
  birds[j++] = new myBird("USA","15-01-03T10:17","CUCULIDA","Smooth-billed Ani","滑嘴犀鹃","Crotophaga ani",[p_id("1501prbirding",16)],["prcnwr","1/2015"],cornellurl("smbani",true),706315);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","STRIGIDA","Eastern Screech-Owl","东美角鸮","Megascops asio",[m_id("")],["ohcvnp","5/2017","Gray morph","灰色形"],3859920);
  ...
  birds[j++] = new myBird("USA","17-02-05T10:12","STRIGIDA","Snowy Owl","雪鸮","Bubo scandiacus",[m_id("20170205_018_SnowyOwl")],["arbitr","2/2017","Davis Road, Bradford County, Pennsylvania, USA","布拉德福德郡戴维斯路，美国宾夕法尼亚州"],1483);
  birds[j++] = new myBird("USA","16-06-10T08:23","STRIGIDA","Burrowing Owl","穴小鸮","Athene cunicularia",p_id("1606florida",[8,7]),["arbitr","6/2016","Brian Piccolo Park, Fort Lauderdale, Florida, USA","劳德代尔堡布莱恩皮克罗公园，美国佛罗里达州"],1115124);
  birds[j++] = new myBird("USA","06-05-07T18:43","STRIGIDA","Barred Owl","横斑林鸮","Strix varia",m_id(["20150425_058_BarredOwl","20160409_033_BarredOwl"]),["mdbmnt","4/2015","arbitr","4/2016","Agricultural History Farm Park, Maryland, USA","农史农场公园，美国马里兰州"],3886420);
//birds[j++] = new myBird("USA","17-00-00T00:00","STRIGIDA","Long-eared Owl","长耳鸮","Asio otus",[m_id("")],["arbitr","3/2017","Middle Creek Wildlife Management Area, Pennsylvania, USA","中溪野生动物管理区，美国宾夕法尼亚州"],18105);
  birds[j++] = new myBird("USA","17-01-01T17:19","STRIGIDA","Short-eared Owl","短耳鸮","Asio flammeus",m_id(["20170101_001_Short-earedOwl","20170101_002_Short-earedOwl"]),["arbitr","1/2017","Harrison Road, Fauquier County, Virginia, USA","福基尔郡哈里森路，美国弗吉尼亚州"],120964);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CAPRIMUL","Lesser Nighthawk","小灰眉夜鹰","Chordeiles acutipennis",[m_id("")],["nvdnwr","7/2015"],cornellurl("lesnig",true),4889822);
//birds[j++] = new myBird("USA","17-00-00T00:00","CAPRIMUL","Chuck-will's-widow","卡氏夜鹰","Antrostomus carolinensis",[m_id("")],["scpitt","9/2015"],4889374);
//birds[j++] = new myBird("USA","17-00-00T00:00","CAPRIMUL","Eastern Whip-poor-will","三声夜鹰","Antrostomus vociferus",[m_id("")],["scpitt","9/2015"],1623143);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","HEMIPROC","Crested Treeswift","凤头雨燕","Hemiprocne coronata",[m_id("")],["mdbhrp","9/2015"],286231);
  birds[j++] = new myBird("USA","15-07-19T08:02","APODIDAE","Chimney Swift","烟囱雨燕","Chaetura pelagica",[m_id("20160618_077_ChimneySwift")],["arbitr","6/2016","Lewes, Delaware, USA","刘易斯，美国特拉华州"],1156237);
//birds[j++] = new myBird("USA","17-00-00T00:00","TROCHILI","Magnificent Hummingbird","大蜂鸟","Eugenes fulgens",[m_id("")],["mdbhrp","9/2015"],4845773);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","TROCHILI","Costa's Hummingbird","科氏蜂鸟","Calypte costae",[m_id("")],["mdbhrp","9/2015"],4891661);
//birds[j++] = new myBird("USA","17-00-00T00:00","TROCHILI","Broad-tailed Hummingbird","宽尾煌蜂鸟","Selasphorus platycercus",[m_id("")],["mdbhrp","9/2015"],4908174);
  birds[j++] = new myBird("USA","15-07-11T09:57","TROCHILI","Rufous Hummingbird","棕煌蜂鸟","Selasphorus rufus",[p_id("1507birdingwest",31)],["arbitr","7/2015","Female, Point Arena, California, USA","雌性，波因特阿里纳，美国加利福尼亚州"],4901729);
  birds[j++] = new myBird("USA","15-01-03T10:48","TROCHILI","Antillean Mango","黑胸芒果蜂鸟","Anthracothorax dominicus",[p_id("1501prbirding",17)],["prcnwr","1/2015","Female"],cornellurl("antman1",true),"黑胸芒果蜂鸟");
  birds[j++] = new myBird("USA","15-01-08T07:32","TROCHILI","Green-throated Carib","绿喉蜂鸟","Eulampis holosericeus",p_id("1501prbirding",[38,53]),["prsanj","1/2015"],cornellurl("grtcar1",true),4871241);
//birds[j++] = new myBird("   ","17-00-00T00:00","COLIIDAE","Speckled Mousebird","斑鼠鸟","Colius striatus",[m_id("")],["mdbhrp","9/2015"],4846814);
//birds[j++] = new myBird("USA","17-00-00T00:00","TROGONID","Elegant Trogon","铜尾美洲咬鹃","Trogon elegans",[m_id("")],["mdbhrp","9/2015"],6867223);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","BRACHYPT","Pitta-like Ground Roller","地三宝鸟","Atelornis pittoides",[m_id("")],["mdbhrp","9/2015"],4886798);
  ...
  birds[j++] = new myBird("USA","06-04-09T09:34","ALCEDINI","Belted Kingfisher","白腹鱼狗","Megaceryle alcyon",[p_id("1512bhill",37),m_id("20160806_090_BeltedKingfisher(F)")],["mdbhrp","8/2015","Male","arbitr","8/2016","Female, Lilypons Water Garden, Maryland, USA","雌性，莉丽庞斯水上花园，美国马里兰州"],2669932);
  birds[j++] = new myBird("USA","15-01-05T06:39","TODIDAE ","Puerto Rican Tody","波多黎各短尾鴗","Todus mexicanus",p_id("1501prbirding",[23,29]),["prceci","1/2015","Male","prceci","1/2015","Female"],cornellurl("purtod1",true),138654);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Lewis's Woodpecker","刘氏啄木鸟","Melanerpes lewis",[m_id("")],["mdbhrp","9/2015"],"刘氏啄木鸟");
  birds[j++] = new myBird("USA","15-01-01T14:01","PICIDAE ","Puerto Rican Woodpecker","波多黎各啄木鸟","Melanerpes portoricensis",p_id("1501prbirding",[1,10]),["prbaya","1/2015","Male","prrinc","1/2015","Female"],cornellurl("purwoo1",true),3913188);
  birds[j++] = new myBird("USA","14-06-01T11:12","PICIDAE ","Red-headed Woodpecker","红头啄木鸟","Melanerpes erythrocephalus",[m_id("20140531_002_Red-headedWoodpecker")],["arbitr","5/2014","Piney Grove Preserve, Sussex County, Virginia, USA","萨塞克斯郡松林保护区，美国弗吉尼亚州"],3912932);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Gila Woodpecker","吉拉啄木鸟","Melanerpes uropygialis",[m_id("")],["mdbhrp","9/2015"],2649065);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Williamson's Sapsucker","威氏吸汁啄木鸟","Sphyrapicus thyroideus",[p_id("1601china",)],["cnbjjp","1/2016"],"威氏吸汁啄木鸟");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Red-naped Sapsucker","红颈吸汁啄木鸟","Sphyrapicus nuchalis",[p_id("1601china",)],["cnbjjp","1/2016"],"红颈吸汁啄木鸟");
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Red-breasted Sapsucker","红胸吸汁啄木鸟","Sphyrapicus ruber",[p_id("1601china",)],["cnbjjp","1/2016"],"红胸吸汁啄木鸟");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Nuttall's Woodpecker","加州啄木鸟","Picoides nuttallii",[p_id("1601china",)],["cnbjjp","1/2016"],-10038);
  birds[j++] = new myBird("USA","05-11-26T09:17","PICIDAE ","Downy Woodpecker","绒啄木鸟","Picoides pubescens",m_id(["20160130_007_DownyWoodpecker(M)","20170827_095_DownyWoodpecker(F)"]),["mdbhrp","1/2016","Male","mdcorl","8/2017","Female"],3949309);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Arizona Woodpecker","亚利桑那啄木鸟","Picoides arizonae",[p_id("1601china",)],["cnbjjp","1/2016"],-10034);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","White-headed Woodpecker","白头啄木鸟","Picoides albolarvatus",[p_id("1601china",)],["cnbjjp","1/2016"],-10041);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","PICIDAE ","Great Spotted Woodpecker","大斑啄木鸟","Dendrocopos major",[p_id("1601china",)],["cnbjjp","1/2016"],15618);
  birds[j++] = new myBird("USA","08-12-13T15:36","PICIDAE ","Northern Flicker","北扑翅鴷","Colaptes auratus",m_id(["20171022_124_NorthernFlicker(M)","20160625_085_NorthernFlicker(F)"]),["mdbhrp","10/2017","Male, yellow-shafted","黄色雄性","nyjbwr","6/2016","Female, yellow-shafted","黄色雌性"],3945688);
//birds[j++] = new myBird("USA","17-00-00T00:00","PICIDAE ","Gilded Flicker","黄扑翅鴷","Colaptes chrysoides",[m_id("")],["mdbhrp","9/2015"],3905287);
  birds[j++] = new myBird("USA","05-12-28T10:22","PICIDAE ","Pileated Woodpecker","北美黑啄木鸟","Dryocopus pileatus",[m_id("20161119_124_PileatedWoodpecker(F)"),"2007cobirding/20070203_019_PileatedWoodpecker(M)"],["mdbhrp","11/2016","Female","mdcovl","2/2007","Male"],3912376);
  ...
  birds[j++] = new myBird("USA","15-03-02T10:16","FALCONID","Merlin","灰背隼","Falco columbarius",[m_id("20161204_134_Merlin(M)"),m_id("20150302_029_Merlin(M)"),p_id("1609vtcanbirding",16)],["nyjbsp","12/2016","Male (Taiga)","雄性(泰加林种)","mdcovl","3/2015","cactnw","9/2016"],[14504,11369887]);
//birds[j++] = new myBird("USA","17-00-00T00:00","FALCONID","Gyrfalcon","矛隼","Falco rusticolus",[m_id("")],["mdbhrp","9/2015"],184717);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","CACATUID","Palm Cockatoo","棕榈凤头鹦鹉","Probosciger aterrimus",[m_id("")],["mdbhrp","9/2015"],49883);
  ...
  birds[j++] = new myBird("USA","15-01-02T07:03","PSITTACI","White-winged Parakeet","淡黄翅鹦哥","Brotogeris versicolurus",[p_id("1501prbirding",3)],["prmaya","1/2015"],cornellurl("whwpar",true),9229616);
//birds[j++] = new myBird("USA","17-00-00T00:00","PSITTACI","Yellow-chevroned Parakeet","黄翅斑鹦哥","Brotogeris chiriri",[m_id("")],["natzo","4/2005"],cornellurl("yecpar",true),2426267);
  birds[j++] = new myBird("USA","16-06-11T09:31","PSITTACI","Orange-winged Parrot","橙翅亚马逊鹦鹉","Amazona amazonica",[p_id("1606florida",20)],["flmahp","4/2005"],cornellurl("orwpar",true),113704);
//birds[j++] = new myBird("USA","17-00-00T00:00","PSITTACI","Nanday Parakeet","南达锥尾鹦鹉","Aratinga nenday",[m_id("")],["natzo","4/2005"],cornellurl("bkhpar",true),994536);
//birds[j++] = new myBird("   ","17-00-00T00:00","PSITTACI","Scarlet Macaw","绯红金刚鹦鹉","Ara macao",["0504zoo/0504zoo__23"],["natzo","4/2005"],cornellurl("scamac1",true),139631);
  birds[j++] = new myBird("USA","16-06-12T08:14","PSITTACI","Blue-crowned Parakeet","蓝冠鹦哥","Thectocercus acuticaudatus",[p_id("1606florida",24)],["arbitr","6/2016","South Beach, Miami, Florida, USA","迈阿密南滩，美国佛罗里达州"],cornellurl("bucpar",true),46205);
//birds[j++] = new myBird("USA","17-00-00T00:00","PSITTACI","Mitred Parakeet","米特雷锥尾鹦鹉","Psittacara mitratus",[m_id("")],["arbitr","6/2016","Lincoln Road Mall, Miami, Florida, USA","迈阿密林肯路购物中心，美国佛罗里达州"],cornellurl("mitpar",true),4884817);
  birds[j++] = new myBird("USA","16-06-12T07:14","PSITTACI","Red-masked Parakeet","红头鹦鹉","Psittacara erythrogenys",p_id("1606florida",[22,21]),["arbitr","6/2016","Lincoln Road Mall, Miami, Florida, USA","迈阿密林肯路购物中心，美国佛罗里达州"],cornellurl("rempar",true),1257150);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","MELANOPA","Collared Crescentchest","领月胸窜鸟","Melanopareia torquata",[m_id("")],["mdbhrp","9/2015"],4269829);
  birds[j++] = new myBird("USA","15-01-03T10:13","TYRANNID","Caribbean Elaenia","加勒比拟霸鹟","Elaenia martinica",[p_id("1501prbirding",15)],["prcnwr","1/2015"],cornellurl("carela1",true),4428283);
//birds[j++] = new myBird("USA","17-00-00T00:00","TYRANNID","Olive-sided Flycatcher","绿胁绿霸鹟","Contopus cooperi",[m_id("")],["mdbhrp","9/2015"],4400045);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","TYRANNID","Cassin's Kingbird","卡氏王霸鹟","Tyrannus vociferans",[m_id("")],["prcnwr","1/2015"],4576852);
  ...
  birds[j++] = new myBird("USA","15-01-05T14:08","TYRANNID","Gray Kingbird","灰王霸鹟","Tyrannus dominicensis",[p_id("1501prbirding",43)],["prosan","1/2015"],cornellurl("grykin",true),4572808);
  birds[j++] = new myBird("USA","15-01-02T07:13","TYRANNID","Loggerhead Kingbird","圆头王霸鹟","Tyrannus caudifasciatus",[p_id("1501prbirding",4)],["prmaya","1/2015"],cornellurl("logkin",true),4572314);
//birds[j++] = new myBird("USA","17-00-00T00:00","TYRANNID","Scissor-tailed Flycatcher","剪尾王霸鹟","Tyrannus forficatus",[m_id("")],["mdocin","3/2017"],715420);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","TEPHRODO","Large Woodshrike","钩嘴林鵙","Tephrodornis virgatus",[p_id("1601china",)],["cnbjjp","1/2016"],275468);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","PACHYCEP","Crested Shriketit","鵙雀鹟","Falcunculus frontatus",[m_id("")],["mdbhrp","9/2015"],7143812);
  ...
  birds[j++] = new myBird("USA","16-02-05T09:01","LANIIDAE","Loggerhead Shrike","呆头伯劳","Lanius ludovicianus",[p_id("1612savannah",11)],["scsnwr","12/2016"],4801026);
  birds[j++] = new myBird("USA","16-12-10T08:44","LANIIDAE","Northern Shrike","灰伯劳","Lanius excubitor",[m_id("20161210_138_NorthernShrike")],["arbitr","12/2016","Ben's Point Road, Queen Anne's County, Maryland, USA","安妮女王郡本点路，美国马里兰州"],71554);
  birds[j++] = new myBird("USA","15-09-13T07:30","VIREONID","White-eyed Vireo","白眼莺雀","Vireo griseus",[m_id("20160911_095_White-eyedVireo"),m_id("20150913_095_White-eyedVireo(I)")],["mdlbrp","9/2016","mdlbrp","9/2015","Immature"],4791453);
  birds[j++] = new myBird("USA","17-06-11T08:21","VIREONID","Yellow-throated Vireo","黄喉莺雀","Vireo flavifrons",[m_id("20170611_074_Yellow-throatedVireo")],["mdmwma","6/2017"],4754888);
  ...
  birds[j++] = new myBird("USA","15-08-22T07:06","VIREONID","Warbling Vireo","歌莺雀","Vireo gilvus",[m_id("20160514_056_WarblingVireo"),p_id("1705ohio",13)],["nyjbwr","5/2016","ohmage","5/2017"],4754756);
//birds[j++] = new myBird("USA","17-00-00T00:00","VIREONID","Philadelphia Vireo","费城莺雀","Vireo philadelphicus",[m_id("")],["mdbhrp","9/2015"],4754879);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","CORVIDAE","Carrion Crow","小嘴乌鸦","Corvus corone",[p_id("1601china",)],["cnbjjp","1/2016"],15185);
  birds[j++] = new myBird("USA","06-04-15T11:43","CORVIDAE","American Crow","短嘴鸦","Corvus brachyrhynchos",[m_id("20170625_078_AmericanCrow")],["mdcovl","6/2017"],3961482);
  ...
  birds[j++] = new myBird("USA","15-03-29T08:49","CORVIDAE","Fish Crow","鱼鸦","Corvus ossifragus",[m_id("20150329_048_FishCrow")],["arbitr","3/2015","Ford's Landing Park, Alexandria, Virginia, USA","亚历山大市福特码头公园，美国弗吉尼亚州"],3971836);
  birds[j++] = new myBird("USA","14-07-05T17:51","CORVIDAE","Common Raven","渡鸦","Corvus corax",p_id("1407michiganbirding",[4,5]),["arbitr","7/2014","Painted Rocks National Lakeshore, Michigan, USA","画石国家湖岸，美国密西根州"],[274388,8696757]);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","BOMBYCIL","Bohemian Waxwing","太平鸟","Bombycilla garrulus",[p_id("1601china",)],["cnbjjp","1/2016"],14757);
//birds[j++] = new myBird("CHN","17-00-00T00:00","BOMBYCIL","Japanese Waxwing","小太平鸟","Bombycilla japonica",[p_id("1601china",)],["cnbjjp","1/2016"],271898);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","STENOSTI","Grey-headed Canary-flycatcher","方尾鹟","Culicicapa ceylonensis",[m_id("")],["mdbhrp","9/2015"],858230);
  ...
  birds[j++] = new myBird("USA","13-07-17T16:16","PARIDAE ","Black-capped Chickadee","黑顶山雀","Poecile atricapillus",[p_id("1609vtcanbirding",11),p_id("1409fingerlake",2)],["calddm","9/2016","arbitr","8/2014","Sapsucker Woods Sanctuary, Ithaca, New York, USA","啄木鸟树林保护区，伊萨卡，美国纽约州"],4820871);
//birds[j++] = new myBird("CAN","17-00-00T00:00","PARIDAE ","Boreal Chickadee","北山雀","Poecile hudsonicus",[p_id("",2)],["caalgp","9/2017"],-3631);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","PARIDAE ","Great Tit","大山雀","Parus major",p_id("1601china",[21,22]),["cnjsxp","1/2016"],32780);
  birds[j++] = new myBird("CHN","16-01-05T10:13","PARIDAE ","Japanese Tit","远东山雀","Parus minor",p_id("1601china",[21,22]),["cnjsxp","1/2016"],12118630);
//birds[j++] = new myBird("USA","17-00-00T00:00","REMIZIDA","Verdin","黄头金雀","Auriparus flaviceps",[m_id("")],["nvdnwr","7/2015"],2639355);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","PYCNONOT","Sooty-headed Bulbul","白喉红臀鹎","Pycnonotus aurigaster",[p_id("1601china",)],["cnbjjp","1/2016"],751572);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","PYCNONOT","Mountain Bulbul","绿翅短脚鹎","Ixos mcclellandii",[p_id("1601china",)],["cnlydp","1/2016","Male"],269463);
//birds[j++] = new myBird("CHN","17-00-00T00:00","PYCNONOT","Chestnut Bulbul","栗背短脚鹎","Hemixos castanonotus",[p_id("1601china",)],["cnlydp","1/2016","Male"],70592);
  birds[j++] = new myBird("CHN","16-01-09T14:54","PYCNONOT","Black Bulbul","黑短脚鹎","Hypsipetes leucocephalus",[p_id("1704longyan",3),p_id("1601china",38)],["cnlydp","4/2017","cnlydp","1/2016","White-headed form","白头形"],264466);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","HIRUNDIN","Violet-green Swallow","紫绿树燕","Tachycineta thalassina",[m_id("")],["nvdnwr","7/2015"],4631564);
  birds[j++] = new myBird("USA","06-04-09T11:23","HIRUNDIN","Northern Rough-winged Swallow","中北美毛翅燕","Stelgidopteryx serripennis",[m_id("20150418_057_NorthernRough-wingedSwallow")],["arbitr","4/2015","Jones Point Park, Virginia, USA","琼斯点公园，美国弗吉尼亚州"],4631285);
  birds[j++] = new myBird("USA","13-07-17T17:11","HIRUNDIN","Bank Swallow","崖沙燕","Riparia riparia",[p_id("1307alaskabirding",6)],["arbitr","7/2013","Point Woronzof Park, Anchorage, Alaska, USA","安克雷奇沃隆佐夫角公园，美国阿拉斯加州"],33027);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","HIRUNDIN","Cave Swallow","穴崖燕","Petrochelidon fulva",[m_id("")],["mdocin","11/2015"],4619010);
  birds[j++] = new myBird("USA","12-06-09T09:07","HIRUNDIN","Barn Swallow","家燕","Hirundo rustica",[p_id("1206brooksidebirding",10),p_id("1505capemay",8),p_id("1704longyan",7)],["mdbrgd","6/2012","njscmm","5/2015","cnlynv","4/2017"],32904);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","AEGITHAL","American Bushtit","短嘴长尾山雀","Psaltriparus minimus",[m_id("")],["mdbhrp","9/2015"],cornellurl("Bushtit"),4822317);
  birds[j++] = new myBird("CHN","17-04-04T07:01","PHYLLOSC","Yellow-browed Warbler","黄眉柳莺","Phylloscopus inornatus",[p_id("1704longyan",17)],["cnlydp","4/2017"],"黄眉柳莺");
//birds[j++] = new myBird("USA","17-00-00T00:00","PHYLLOSC","Arctic Warbler","极北柳莺","Phylloscopus borealis",[m_id("")],["mdbhrp","9/2015"],32602);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","BERNIERI","White-throated Oxylabes","白喉尖鹛","Oxylabes madagascariensis",[m_id("")],["mdbhrp","9/2015"],4862807);
  birds[j++] = new myBird("CHN","17-04-03T11:10","CISTICOL","Hill Prinia","山鹪莺","Prinia superciliaris",p_id("1704longyan",[10,11]),["cnlynv","4/2017"],849723);
  birds[j++] = new myBird("CHN","17-04-03T11:10","CISTICOL","Yellow-bellied Prinia","黄腹鹪莺","Prinia flaviventris",[p_id("1704longyan",9)],["cnlynv","4/2017"],"黄腹鹪莺");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","TROGLODY","Canyon Wren","墨西哥鹪鹩","Catherpes mexicanus",[m_id("")],["mdocin","10/2015"],"墨西哥鹪鹩");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","TROGLODY","Cactus Wren","棕曲嘴鹪鹩","Campylorhynchus brunneicapillus",[m_id("")],["nvdnwr","7/2015"],"棕曲嘴鹪鹩");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","POLIOPTI","Black-tailed Gnatcatcher","黑尾蚋莺","Polioptila melanura",[m_id("")],["mdbhrp","9/2015"],4844749);
  ...
  birds[j++] = new myBird("USA","06-02-20T13:41","SITTIDAE","White-breasted Nuthatch","白胸䴓","Sitta carolinensis",m_id(["20161111_119_White-breastedNuthatch(M)","20160130_004_White-breastedNuthatch(F)"]),["mdbhrp","11/2016","Male","mdbhrp","1/2016","Female"],1986978);
//birds[j++] = new myBird("USA","17-00-00T00:00","SITTIDAE","Pygmy Nuthatch","小䴓","Sitta pygmaea",[m_id("")],["mdbhrp","9/2015"],8653131);
  birds[j++] = new myBird("USA","15-11-26T11:20","SITTIDAE","Brown-headed Nuthatch","褐头䴓","Sitta pusilla",p_id("1604asheville",[6,7]),["ncllmp","4/2016","ncllmp","4/2016","Immature"],8538620);
//birds[j++] = new myBird("   ","17-00-00T00:00","TICHODRO","Wallcreeper","红翅旋壁雀","Tichodroma muraria",[m_id("")],["mdbhrp","9/2015"],271527);
  ...
  birds[j++] = new myBird("USA","06-04-29T08:10","MIMIDAE ","Gray Catbird","灰嘲鸫","Dumetella carolinensis",[m_id("20160924_098_GrayCatbird"),p_id("1206brooksidebirding",5)],["mdlbrp","9/2016","mdbrgd","6/2012","Immature"],1594003);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","MIMIDAE ","Le Conte's Thrasher","勒氏弯嘴嘲鸫","Toxostoma lecontei",[m_id("")],["mdbhrp","9/2015"],4078707);
  birds[j++] = new myBird("USA","15-01-08T12:54","MIMIDAE ","Pearly-eyed Thrasher","珠眼嘲鸫","Margarops fuscatus",[p_id("1501prbirding",49)],["prosan","1/2015"],cornellurl("peethr1",true),4077575);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","TURDIDAE","Dusky Thrush","斑鸫","Turdus eunomus",[p_id("1601china",)],["cnbjjp","1/2016"],10472312);
  birds[j++] = new myBird("USA","15-01-08T07:25","TURDIDAE","Red-legged Thrush","红腿鸫","Turdus plumbeus",[p_id("1501prbirding",36)],["prsanj","1/2015"],cornellurl("relthr1",true),4840639);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","MUSCICAP","Bluethroat","蓝喉歌鸲","Luscinia svecica",[m_id("")],["mdbhrp","9/2015"],14290);
  birds[j++] = new myBird("CHN","17-04-03T06:42","MUSCICAP","Narcissus Flycatcher","黄眉姬鹟","Ficedula narcissina",[p_id("1704longyan",4)],["cnlydp","4/2017","Male"],"黄眉姬鹟");
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CINCLIDA","American Dipper","美洲河鸟","Cinclus mexicanus",[m_id("")],["mdbhrp","9/2015"],2964978);
//birds[j++] = new myBird("CHN","17-00-00T00:00","CHLOROPS","Blue-winged Leafbird","蓝翅叶鹎","Chloropsis cochinchinensis",[p_id("1601china",)],["cnlydp","1/2016","Male"],855514);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","DICAEIDA","Fire-breasted Flowerpecker","红胸啄花鸟","Dicaeum ignipectus",[p_id("1601china",)],["cnlydp","1/2016","Male"],32774);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","PLOCEIDA","Red-billed Quelea","红嘴奎利亚雀","Quelea quelea",[p_id("1601china",)],["cnbjjp","1/2016"],277030);
  birds[j++] = new myBird("USA","15-01-05T14:42","ESTRILDI","Bronze Mannikin","铜色文鸟","Spermestes cucullata",p_id("1501prbirding",[27,28]),["prceci","1/2015","prceci","1/2015","Immature"],cornellurl("broman1",true),4756354);
...
//birds[j++] = new myBird("CHN","17-00-00T00:00","ESTRILDI","Scaly-breasted Munia","斑文鸟","Lonchura punctulata",[p_id("1601china",)],["cnlydp","1/2016","Male"],56800);
...
//birds[j++] = new myBird("   ","17-00-00T00:00","UROCYNCH","Przevalski's Finch","朱鹀","Urocynchramus pylzowi",[m_id("")],["mdbhrp","9/2015"],33042);
  ...
  birds[j++] = new myBird("USA","17-02-11T11:47","FRINGILL","Red Crossbill","红交嘴雀","Loxia curvirostra",[m_id("20170211_020_RedCrossbill")],["arbitr","2/2017","Male red, female yellow-green, Owl Creek Park, Schuylkill County, Pennsylvania, USA","雄性带红色，雌性黄绿色，斯古吉尔郡鸮河公园，美国宾夕法尼亚州"],71619);
//birds[j++] = new myBird("USA","17-00-00T00:00","FRINGILL","White-winged Crossbill","白翅交嘴雀","Loxia leucoptera",[m_id("")],["caalgp","9/2017"],661414);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","FRINGILL","Evening Grosbeak","黄昏锡嘴雀","Coccothraustes vespertinus",[m_id("")],["caalgp","9/2017"],1596096);
  ...
  birds[j++] = new myBird("USA","15-01-06T09:16","PARULIDA","Louisiana Waterthrush","白眉灶莺","Parkesia motacilla",[p_id("1501prbirding",31)],["arbitr","1/2015","El Yunque National Forest, Puerto Rico, USA","云盖热带雨林，美国波多黎各"],4751897);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Golden-winged Warbler","金翅虫森莺","Vermivora chrysoptera",[m_id("")],["scpatp","9/2015"],4751941);
  ...
  birds[j++] = new myBird("USA","06-07-01T10:10","PARULIDA","Prothonotary Warbler","蓝翅黄森莺","Protonotaria citrea",[m_id("20170611_072_Prothonotary(M)"),"2006cobirding/ProthonotaryWarbler_F_20060730_009",m_id("20170611_073_Prothonotary(I)")],["mdmwma","6/2017","Male","mdcorl","7/2006","Female","mdmwma","6/2017","Immature"],1987007);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Bay-breasted Warbler","栗胸林莺","Setophaga castanea",[m_id("")],["mdbhrp","9/2015"],4752102);
  ...
  birds[j++] = new myBird("USA","15-09-12T07:38","PARULIDA","Chestnut-sided Warbler","栗胁林莺","Setophaga pensylvanica",[m_id("20170827_094_Chestnut-sidedWarbler(I)")],["mdlbrp","8/2017","Immature"],1120612);
  ...
  birds[j++] = new myBird("USA","15-05-10T12:54","PARULIDA","Black-throated Blue Warbler","黑喉蓝林莺","Setophaga caerulescens",[m_id("20170910_102_Black-throatedBlueWarbler(M)")],["mdlbrp","9/2017","Male"],4738127);
  birds[j++] = new myBird("USA","06-04-09T10:02","PARULIDA","Palm Warbler","棕榈林莺","Dendroica palmarum",[p_id("1604asheville",9),m_id("20151025_112_PalmWarbler(FP)")],["ncllmp","4/2016","mdbmnt","10/2015","Fall plumage"],4752118);
  ...
  birds[j++] = new myBird("USA","06-04-02T11:16","PARULIDA","Yellow-rumped Warbler","黄腰白喉林莺","Dendroica coronata",[p_id("1604asheville",8),m_id("20151101_121_Yellow-rumpedWarbler(I)")],["ncllmp","4/2016","Male, Myrtle form","雄性，长春花形","mdbmnt","11/2015","Female/immature, Myrtle form","雌性/未成年，长春花形"],4752009);
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Yellow-throated Warbler","黄喉林莺","Dendroica dominica",[p_id("asheville",)],["ohcvnp","5/2017"],4751822);
  birds[j++] = new myBird("USA","15-05-09T09:59","PARULIDA","Prairie Warbler","草原林莺","Setophaga discolor",m_id(["20170709_082_PrairieWarbler(M)","20170709_081_PrairieWarbler(I)"]),["mdlbrp","7/2017","Male","mdlbrp","7/2017","Immature"],4752096);
  birds[j++] = new myBird("USA","15-01-03T10:58","PARULIDA","Adelaide's Warbler","黄腹灰林莺","Setophaga adelaidae",[p_id("1501prbirding",18)],["prcnwr","1/2015"],cornellurl("adewar1",true),4752090);
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Grace's Warbler","黄喉纹胁林莺","Setophaga graciae",[m_id("")],["mdbhrp","9/2015"],4751901);
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Black-throated Gray Warbler","黑喉灰林莺","Setophaga nigrescens",[m_id("")],["mdhadg","12/2016"],4751918);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","PARULIDA","Golden-cheeked Warbler","金颊黑背林莺","Setophaga chrysoparia",[m_id("")],["mdbhrp","9/2015"],4708253);
  ...
  birds[j++] = new myBird("USA","17-08-19T08:25","PARULIDA","Canada Warbler","加拿大威森莺","Cardellina canadensis",[m_id("20170826_092_CanadaWarbler")],["mdmwma","8/2017"],4751630);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Yellow-headed Blackbird","黄头黑鹂","Xanthocephalus xanthocephalus",[m_id("")],["arbitr","3/2017","Male, Hopkins Farm, Harford County, Maryland, USA","雄性，哈佛郡霍普金斯农场，美国马里兰州"],4708909);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Great-tailed Grackle","大尾拟八哥","Quiscalus mexicanus",[m_id("")],["mdbhrp","9/2015"],4706667);
  birds[j++] = new myBird("USA","15-01-02T09:39","ICTERIDA","Greater Antillean Grackle","黑拟八哥","Quiscalus niger",p_id("1501prbirding",[6,7]),["prrinc","1/2015"],cornellurl("gragra1",true),4706467);
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Shiny Cowbird","紫辉牛鹂","Molothrus bonariensis",[m_id("")],["flevnp","6/2016"],4706494);
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Bronzed Cowbird","铜色牛鹂","Molothrus aeneus",[m_id("")],["flevnp","6/2016"],4706501);
  ...
  birds[j++] = new myBird("USA","06-07-01T09:43","ICTERIDA","Orchard Oriole","圃拟鹂","Icterus spurius",[p_id("1604asheville",11),p_id("1604asheville",10),p_id("1505bombayhook",12)],["ncllmp","4/2016","Male","ncllmp","4/2016","Female","debnwr","5/2015","Juvenile male"],4704368);
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Hooded Oriole","巾冠拟鹂","Icterus cucullatus",[m_id("")],["mdbhrp","9/2015"],4704336);
  ...
  birds[j++] = new myBird("USA","06-05-24T18:03","ICTERIDA","Baltimore Oriole","橙腹拟鹂","Icterus galbula",m_id(["20150830_093_BaltimoreOriole(M)","20170618_077_BaltimoreOriole"]),["mdbrgd","8/2015","Male","mdcovl","6/2017"],4704343);
//birds[j++] = new myBird("USA","17-00-00T00:00","ICTERIDA","Scott's Oriole","斯氏拟鹂","Icterus parisorum",[m_id("")],["mdbhrp","9/2015"],4707365);
  birds[j++] = new myBird("USA","15-01-03T13:57","ICTERIDA","Venezuelan Troupial","委内瑞拉拟鹂","Icterus icterus",[p_id("1501prbirding",20)],["arbitr","1/2015","Guanica Dry Forest, Puerto Rico, USA","瓜尼卡干燥森林，美国波多黎各"],cornellurl("ventro1",true),3179670);
  birds[j++] = new myBird("USA","15-01-01T14:06","COEREBID","Bananaquit","曲嘴森莺","Coereba flaveola",[p_id("1501prbirding",2)],["prbaya","1/2015"],cornellurl("banana",true),4738553);
//birds[j++] = new myBird("CHN","17-00-00T00:00","EMBERIZI","Pine Bunting","白头鹀","Emberiza leucocephalos",p_id("1601china",[1,2]),["cnbjjp","1/2016"],660030);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","EMBERIZI","Bachman's Sparrow","巴氏猛雀鹀","Peucaea aestivalis",[m_id("")],["scjwwc","12/2016"],"https://www.audubon.org/field-guide/bird/bachmans-sparrow",6114539);
  ...
  birds[j++] = new myBird("USA","15-04-18T07:36","EMBERIZI","Chipping Sparrow","棕顶雀鹀","Spizella passerina",[m_id("20160409_034_ChippingSparrow"),p_id("1612savannah",12)],["arbitr","4/2016","Agricultural History Farm Park, Maryland, USA","农史农场公园，美国马里兰州","scjwwc","12/2016","Winter plumage"],4723786);
  birds[j++] = new myBird("USA","17-09-16T10:48","EMBERIZI","Clay-colored Sparrow","褐雀鹀","Spizella pallida",[m_id("20170916_103_Clay-coloredSparrow")],["mdocci","9/2017","",""," Sunset Park","日落公园"],4723791);
  ...
  birds[j++] = new myBird("USA","16-10-22T13:34","EMBERIZI","Vesper Sparrow","栗肩雀鹀","Pooecetes gramineus",[m_id("20161022_105_VesperSparrow")],["arbitr","10/2016","Perryman Park, Aberdeen, Maryland, USA","阿伯丁市佩里曼公园，美国马里兰州"],4723988);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","EMBERIZI","Black-throated Sparrow","黑喉漠鹀","Amphispiza bilineata",[m_id("")],["mdbhrp","9/2015"],4723738);
  birds[j++] = new myBird("USA","13-07-17T18:46","EMBERIZI","Savannah Sparrow","稀树草鹀","Passerculus sandwichensis",[p_id("1307alaskabirding",8)],["arbitr","7/2013","Potter Marsh, Anchorage, Alaska, USA","安克雷奇波特沼泽，美国阿拉斯加州"],4724003);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","EMBERIZI","Le Conte's Sparrow","莱氏沙鹀","Ammodramus leconteii",[m_id("")],["mdswhf","2/2017"],7850355);
  ...
  birds[j++] = new myBird("USA","17-03-05T09:21","EMBERIZI","Lincoln's Sparrow","林氏带鹀","Melospiza lincolnii",m_id(["20170305_030_Lincoln'sSparrow","20170305_029_Lincoln'sSparrow"]),["arbitr","3/2017","Occoquan Bay National Wildlife Refuge, Virginia, USA","奥科宽湾国家野生动物保护区，美国弗吉尼亚州"],4745989);
  ...
  birds[j++] = new myBird("USA","15-01-07T07:12","THRAUPID","Saffron Finch","橙黄雀鹀","Sicalis flaveola",p_id("1501prbirding",[34,55]),["prsanj","1/2015","prsanj","1/2015","Immature"],cornellurl("saffin",true),4717104);
//birds[j++] = new myBird("   ","17-00-00T00:00","THRAUPID","Silver-beaked Tanager","银嘴唐纳雀","Ramphocelus carbo",["0504zoo/0504zoo__24"],["natzo","4/2005"],cornellurl("sibtan2",true),4748894);
  birds[j++] = new myBird("USA","15-01-07T07:05","THRAUPID","Black-faced Grassquit","黑脸草雀","Tiaris bicolor",p_id("1501prbirding",[50,33]),["prsanj","1/2015","Male","prsanj","1/2015","Female"],cornellurl("bkfgra",true),4722827);
//birds[j++] = new myBird("USA","17-00-00T00:00","THRAUPID","Western Spindalis","纹头唐纳雀","Spindalis zena",[m_id("")],["mdbhrp","9/2015"],cornellurl("wesspi",true),4749011);
//birds[j++] = new myBird("USA","17-00-00T00:00","THRAUPID","Hispaniolan Spindalis","海地纹头唐纳雀","Spindalis dominicensis",[m_id("")],["mdbhrp","9/2015"],cornellurl("hisspi",true),4748633);
  birds[j++] = new myBird("USA","15-01-03T06:35","THRAUPID","Puerto Rican Spindalis","波多纹头唐纳雀","Spindalis portoricensis",p_id("1501prbirding",[11,54]),["prponc","1/2015","Male","prsanj","1/2015","Female"],cornellurl("purspi",true),4749024);
//birds[j++] = new myBird("USA","17-00-00T00:00","THRAUPID","Jamaican Spindalis","牙买加纹头唐纳雀","Spindalis nigricephala",[m_id("")],["mdbhrp","9/2015"],cornellurl("jamspi",true),4748682);
  birds[j++] = new myBird("USA","16-12-04T09:51","CALCARII","Lapland Longspur","铁爪鹀","Calcarius lapponicus",[m_id("20161204_136_LaplandLongspur")],["nyjbsp","12/2016","Female"],476834);
  birds[j++] = new myBird("USA","16-12-04T08:10","CALCARII","Snow Bunting","雪鹀","Plectrophenax nivalis",[m_id("20161204_129_SnowBunting")],["nyjbsp","12/2016","Winter plumage"],660006);
  birds[j++] = new myBird("USA","15-05-02T08:21","CARDINAL","Summer Tanager","玫红丽唐纳雀","Piranga rubra",[m_id("20170625_079_SummerTanager(M)")],["mdcovl","6/2017","Male"],4748745);
...
//birds[j++] = new myBird("USA","17-00-00T00:00","CARDINAL","Western Tanager","黄腹丽唐纳雀","Piranga ludoviciana",[m_id("")],["mdbhrp","9/2015"],4748675);
  birds[j++] = new myBird("USA","05-12-24T16:03","CARDINAL","Northern Cardinal","主红雀","Cardinalis cardinalis",[p_id("1604asheville",16),m_id("20170108_006_NorthernCardinal(F)")],["nccrsp","4/2016","Male","mdmapp","1/2017","Female"],722438);
  ...
  birds[j++] = new myBird("USA","14-08-30T16:45","CARDINAL","Rose-breasted Grosbeak","玫胸白斑翅雀","Pheucticus ludovicianus",[p_id("1409fingerlake",6),p_id("1512bhill",42)],["arbitr","8/2014","Female, Salmon Creek Road, New York, USA","雌性，鲑鱼河路，美国纽约州","mdbhrp","9/2015","Immature male"],4716584);
  ...
  birds[j++] = new myBird("USA","06-06-08T15:10","CARDINAL","Indigo Bunting","靛彩鹀","Passerina cyanea",[p_id("1505bombayhook",14),m_id("20170709_083_IndigoBunting(F)")],["debnwr","5/2015","Male","mdlbrp","7/2017","Female"],4716631);
  ...
  birds[j++] = new myBird("USA","17-05-24T07:33","CARDINAL","Dickcissel","美洲雀","Spiza americana",m_id(["20170524_065_Dickcissel(M)","20170524_064_Dickcissel(F)"]),["arbitr","5/2017","Male"+(tmp1=", Underwood Road, Howard County, Maryland, USA"),"雄性"+(tmp2="，霍华德郡安德伍德路，美国马里兰州"),"arbitr","5/2017","Female"+tmp1,"雌性"+tmp2],1155714);
  ...
  function getByCountry(id, myArray){
     var code = "non";
     for (var key in cnt_nm){
          var val=cnt_nm[key];
          if (val[0].toLowerCase()==id.trim().toLowerCase() || val[1]==id.trim()) {
              code = key; 
              break;
          }
     }
