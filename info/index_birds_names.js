<!--
  //date
  var modiDate  = new Date("2021-01-30T08:00");
...
//birds[j++] = new myBird("21-00-00T00:00","DROMAIID","Emu","鸸鹋","Dromaius novaehollandiae",[m_id("")],["mdbhrp","9/2015"],"emu1");
...
//birds[j++] = new myBird("21-00-00T00:00","ANATIDAE","Pink-footed Goose","粉脚雁","Anser brachyrhynchus",[m_id("")],["papapa","2/2021","East Allen Township, Northampton County","","","北安普敦郡东艾伦镇"],"pifgoo");
...
//birds[j++] = new myBird("21-00-00T00:00","ANATIDAE","Tufted Duck","凤头潜鸭","Aythya fuligula",[m_id("")],["mdbhrp","9/2015"],"tufduc");
  ...
  birds[j++] = new myBird("21-01-10T15:58","ANATIDAE","Barrow's Goldeneye","巴氏鹊鸭","Bucephala islandica",[m_id("20210110_007_BarrowGoldeneye")],["mdmdmd","1/2021","Male, Point Lookout State Park","","","眺望点州立公园"]);
...
//birds[j++] = new myBird("21-00-00T00:00","GRUIDAE ","White-naped Crane","白枕鹤","Grus vipio",["0504zoo/0504zoo__9"],["natzo","4/2005"],"whncra1");
//birds[j++] = new myBird("21-00-00T00:00","GRUIDAE ","Blue Crane","蓝蓑羽鹤","Anthropoides paradisea",["0504zoo/0504zoo__10"],["natzo","4/2005"],"blucra2");
...
//birds[j++] = new myBird("21-00-00T00:00","SCOLOPAC","Upland Sandpiper","高原鹬","Bartramia longicauda",[m_id("")],["mdolan","7/2016"]);
...
//birds[j++] = new myBird("21-00-00T00:00","SCOLOPAC","Ruff","流苏鹬","Calidris pugnax",[m_id("")],["mdocci","2/2021","Nonbreeding plumage",""," Inlet","海口"],"ruff");
...
//birds[j++] = new myBird("21-00-00T00:00","LARIDAE ","Little Gull","小鸥","Hydrocoloeus minutus",[m_id("")],["deinr","12/2020"]);
...
//birds[j++] = new myBird("21-00-00T00:00","LARIDAE ","Gull-billed Tern","鸥嘴噪鸥","Gelochelidon nilotica",[m_id("")],["schbsp","6/2018"]);
...
//birds[j++] = new myBird("21-00-00T00:00","STRIGIDA","Northern Saw-whet Owl","棕榈鬼鸮","Aegolius acadicus",[m_id("")],["arb","12/2020"]);
  birds[j++] = new myBird("21-01-06T11:29","STRIGIDA","Long-eared Owl","长耳鸮","Asio otus",[m_id("20210115_012_Long-earedOwl")],["vavava","1/2021","State Arboretum of Virginia","","","州立植物园"]);
...
//birds[j++] = new myBird("21-00-00T00:00","MEGALAIM","Great Barbet","大拟啄木鸟","Megalaima virens",[m_id("")],["mdbhrp","9/2015"],"grebar1");
...
//birds[j++] = new myBird("21-00-00T00:00","FALCONID","Gyrfalcon","矛隼","Falco rusticolus",[m_id("")],["mdbhrp","9/2015"]);
  birds[j++] = new myBird("15-06-07T11:55","FALCONID","Peregrine Falcon","游隼","Falco peregrinus",m_id(["20150607_076_PeregrineFalcon","20210314_029_PeregrineFalcon"]),["mdcocn","6/2015","",""," at Maryland Heights","马里兰高地一带","mdcocn","3/2021","",""," at Maryland Heights","马里兰高地一带"]);
...
//birds[j++] = new myBird("21-00-00T00:00","EURYLAIM","African Broadbill","非洲阔嘴鸟","Smithornis capensis",[m_id("")],["mdbhrp","9/2015"],"afrbro1");
...
//birds[j++] = new myBird("21-00-00T00:00","MELIPHAG","Black Honeyeater","黑吸蜜鸟","Sugomel nigrum",[m_id("")],["mdbhrp","9/2015"],"blahon1");
...
//birds[j++] = new myBird("21-00-00T00:00","PACHYCEP","Crested Shriketit","鵙雀鹟","Falcunculus frontatus",[m_id("")],["mdbhrp","9/2015"],"crstit1");
...
//birds[j++] = new myBird("21-00-00T00:00","CETTIIDA","Mountain Tailorbird","栗头缝叶莺","Phyllergates cuculatus",[m_id("")],["mdbhrp","9/2015"],"moutai2");
//birds[j++] = new myBird("21-00-00T00:00","SCOTOCER","Streaked Scrub Warbler","纹鹪莺","Scotocerca inquieta",[m_id("")],["mdbhrp","9/2015"]);
//birds[j++] = new myBird("21-00-00T00:00","ERYTHROC","Chestnut-capped Flycatcher","栗顶红鹟","Erythrocercus mccallii",[m_id("")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("21-00-00T00:00","PELLORNE","Dusky Fulvetta","褐顶雀鹛","Alcippe brunnea",[m_id("")],["mdbhrp","9/2015"],"dusful1");
...
//birds[j++] = new myBird("21-00-00T00:00","SYLVIIDA","Wrentit","鹪雀莺","Chamaea fasciata",[m_id("")],["mdbhrp","9/2015"]);
//birds[j++] = new myBird("21-00-00T00:00","ZOSTEROP","Striated Yuhina","栗耳凤鹛","Yuhina castaniceps",[p_id("1601china",)],["cnlydp","1/2016","Male"],"stryuh1");
...
//birds[j++] = new myBird("21-00-00T00:00","UROCYNCH","Przevalski's Finch","朱鹀","Urocynchramus pylzowi",[m_id("")],["mdbhrp","9/2015"],"przros1");
  ...
  birds[j++] = new myBird("20-11-16T10:43","FRINGILL","Evening Grosbeak","黄昏锡嘴雀","Coccothraustes vespertinus",m_id(sas("20201116_12",["4","5","6"],"_EveningGrosbeak")),["vavava","11/2020","M"+(tmp1="ale, Shenandoah River Campus at Cool Spring Battlefield"),"","",(tmp2="雪兰多大学冷泉战场临河校区"),"vavava","11/2020","Fem"+tmp1,"","",tmp2]);
...
//birds[j++] = new myBird("21-00-00T00:00","ICTERIDA","Yellow-headed Blackbird","黄头黑鹂","Xanthocephalus xanthocephalus",[m_id("")],["arb","3/2017","Male, Hopkins Farm, Harford County, Maryland, USA","雄性，美国马里兰州哈福德霍普金斯农场"]);
...
//birds[j++] = new myBird("21-00-00T00:00","PARULIDA","Swainson's Warbler","白眉食虫莺","Limnothlypis swainsonii",[m_id("",)],["arb","7/2020","West Penn Trail, Indiana County, Pennsylvania, USA","美国宾夕法尼亚州印第安纳郡西宾小道"]);
...
//birds[j++] = new myBird("21-00-00T00:00","PARULIDA","Wilson's Warbler","黑头威森莺","Cardellina pusilla",[m_id()],["mdbhrp","9/2016","Female"]);
...
//birds[j++] = new myBird("21-00-00T00:00","MITROSPI","Dusky-faced Tanager","乌脸唐纳雀","Mitrospingus cassinii",[m_id("")],["mdbhrp","9/2015"],"duftan1");
  ...
  birds[j++] = new myBird("21-01-30T11:53","CARDINAL","Western Tanager","黄腹丽唐纳雀","Piranga ludoviciana",[m_id("20210130_020_WesternTanager")],["vavava","1/2021","Female, Bacon Street, Yorktown, York County","","","约克郡约克镇培根街"]);
