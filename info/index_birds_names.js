...
//    txsnwr:  ["Santa Ana National Wildlife Refuge","Texas, USA","圣安娜国家野生动物保护区","美国德克萨斯州",npsurl("santa_ana",true)],
  ...
  var py  =  { 额:"e2", 鹅:"e2", 鹗:"e4", 阿:"a1", 峨:"e2", 恶:"e4", 纳:"na4",蚁:"yi3",鸸:"er2", 斗:"dou4",树:"shu4",茶:"cha2",林:"lin2",白:"bai2",赤:"chi4",肉:"rou4",竹:"zhu2",寒:"han2",台:"tai2",雷:"lei2", 环:"huan2",平:"ping2",横:"heng2",苍:"cang1",娇:"jiao1",寿:"shou4",亨:"heng1", 胜:"sheng4",
      ...
      鸲:"qu2",鹡:"ji2",圃:"pu3",布:"bu4",河:"he2",鵖:"bi1",斯:"si1",鸬:"lu2",苏:"su1",那:"na4", 玫:"mei2",昏:"hun1",弯:"wan1",腿:"tui3",花:"hua1",灶:"zao4",文:"wen2",琉:"liu2",穗:"sui4",支:"zhi1",窜:"cuan4",鸰:"ling2",唐:"tang2",剑:"jian4",松:"song1",枞:"cong1",爪:"zhao3",鲸:"jing1", 鵟:"kuang2",
...
//birds[j++] = new myBird("20-00-00T00:00","ANATIDAE","Cinnamon Teal","桂红鸭","Spatula cyanoptera",[m_id("")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("20-00-00T00:00","MEGAPODI","Dusky Megapode","普通冢雉","Megapodius freycinet",[m_id("")],["mdbhrp","9/2015"],"dusscr2");
//birds[j++] = new myBird("20-00-00T00:00","CRACIDAE","Plain Chachalaca","纯色小冠雉","Ortalis vetula",[m_id("")],["txsnwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","PODICIPE","Least Grebe","侏䴙䴘","Tachybaptus dominicus",[m_id("")],["txsnwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","THRESKIO","White-faced Ibis","白脸彩鹮","Plegadis chihi",[m_id("")],["arb","6/2017","Deal Island Wildlife Management Area, Maryland, USA","美国马里兰州迪尔岛野生动物管理区"]);
...
//birds[j++] = new myBird("20-00-00T00:00","ARDEIDAE","Least Bittern","姬苇鳽","Ixobrychus exilis",[m_id("")],["schbsp","6/2018"]);
...
//birds[j++] = new myBird("20-00-00T00:00","PHALACRO","Neotropic Cormorant","美洲鸬鹚","Phalacrocorax brasilianus",[p_id("2001txbirding",8)],["txanwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","ACCIPITR","Harris's Hawk","栗翅鹰","Parabuteo unicinctus",[m_id("")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("20-00-00T00:00","GRUIDAE ","Whooping Crane","美洲鹤","Grus americana",[p_id("2001txbirding",8)],["txanwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","SCOLOPAC","Long-billed Curlew","长嘴杓鹬","Numenius americanus",[p_id("2001txbirding",8)],["txanwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","SCOLOPAC","Ruff","流苏鹬","Philomachus pugnax",[m_id("")],["arb","4/2017","Augustine Wildlife Area-Port Penn Impoundments, Delaware, USA","美国特拉华州奥古斯丁野生动物保护区"],"ruff");
//birds[j++] = new myBird("20-00-00T00:00","SCOLOPAC","Stilt Sandpiper","高跷鹬","Calidris himantopus",[m_id("")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("20-00-00T00:00","STERCORA","Parasitic Jaeger","短尾贼鸥","Stercorarius parasiticus",[m_id("")],["mdocin","10/2015"],"parjae");
...
//birds[j++] = new myBird("20-00-00T00:00","CAPRIMUL","Lesser Nighthawk","小灰眉夜鹰","Chordeiles acutipennis",[m_id("")],["nvdnwr","7/2015"],"lesnig");
...
//birds[j++] = new myBird("20-00-00T00:00","ALCEDINI","Green Kingfisher","绿鱼狗","Chloroceryle americana",p_id("1601china",[23,30]),["txsnwr","1/2020"],"grnkin");
//birds[j++] = new myBird("20-00-00T00:00","ALCEDINI","Ringed Kingfisher","棕腹鱼狗","Megaceryle torquata",p_id("1601china",[23,30]),["txsnwr","1/2020"],"rinkin1");
...
//birds[j++] = new myBird("20-00-00T00:00","FALCONID","Crested Caracara","北美凤头卡拉鹰","Caracara cheriway",[p_id("2001txbirding",8)],["txanwr","1/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","TYRANNID","Scissor-tailed Flycatcher","剪尾王霸鹟","Tyrannus forficatus",[m_id("")],["mdocin","3/2017"]);
...
//birds[j++] = new myBird("20-00-00T00:00","CORVIDAE","Green Jay","绿蓝鸦","Cyanocorax yncas",[p_id("1601china",)],["txsnwr","12/2019"]);
...
//birds[j++] = new myBird("20-00-00T00:00","PARIDAE ","Black-crested Titmouse","黑冠凤头山雀","Baeolophus atricristatus",[m_id("20161112_120_TuftedTitmouse")],["txsnwr","12/2019"],3593);
...
//birds[j++] = new myBird("20-00-00T00:00","FRINGILL","Evening Grosbeak","黄昏锡嘴雀","Coccothraustes vespertinus",[m_id("")],["mdcorl","2/2019","Female"]);
...
//birds[j++] = new myBird("20-00-00T00:00","FRINGILL","White-winged Crossbill","白翅交嘴雀","Loxia leucoptera",[m_id("")],["caalgp","9/2017"]);
...
//birds[j++] = new myBird("20-00-00T00:00","ICTERIDA","Tricolored Blackbird","三色黑鹂","Agelaius tricolor",[m_id("")],["njscmm","5/2015"],"tribla");
...
//birds[j++] = new myBird("20-00-00T00:00","PARULIDA","Swainson's Warbler","白眉食虫莺","Limnothlypis swainsonii",[p_id("asheville",)],["nccrsp","4/2016"]);
...
//birds[j++] = new myBird("20-00-00T00:00","PARULIDA","Kentucky Warbler","黄腹地莺","Geothlypis formosa",[m_id("")],["mdbhrp","9/2015"]);
