...
//birds[j++] = new myBird("21-00-00T00:00","ANATIDAE","Fulvous Whistling-Duck","茶色树鸭","Dendrocygna bicolor",[m_id("")],["fllawd","9/2019"]);
  ...
  birds[j++] = new myBird("15-12-31T08:48","ANATIDAE","Cackling Goose","小美洲黑雁","Branta hutchinsii",[m_id("20151231_140_CacklingGoose")],["mdmdmd","12/2015","At the center with the smallest bill, "+gmap("River Bend Park",39.4447,-77.3866)+", Frederick","中间嘴最小的大雁","","弗雷德里克市河湾公园"],"加拿大黑雁北部亚种");
...
//birds[j++] = new myBird("21-00-00T00:00","ANATIDAE","Mandarin Duck","鸳鸯","Aix galericulata",[p_id()],["cnxihu","4/2005"],"manduc");
  ...
  birds[j++] = new myBird("15-11-22T09:50","ANATIDAE","Green-winged Teal","绿翅鸭","Anas crecca",m_id(["20151122_128_Green-wingedTeal(M)","20210204_023_EurasianTeal"]),["vahump","11/2015","American males","北美亚种雄性","vavava","2/2021","Eurasian male, "+gmap("Middlesex Drive Pond",38.90828,-77.48343)+", Loudoun County","欧亚亚种雄性","","劳登郡米德尔塞克斯路池塘"]);
...
//birds[j++] = new myBird("21-00-00T00:00","SCOLOPAC","Ruff","流苏鹬","Calidris pugnax",[m_id("")],["debnwr","5/2021","Female"],"ruff");
  ...
  birds[j++] = new myBird("15-09-07T07:44","SCOLOPAC","Sanderling","三趾滨鹬","Calidris alba",[p_id("1612savannah",15),p_id("1509charleston",17)],["arb","12/2016","Winter plumage, "+gmap("Tybee Island",31.98666,-80.85212)+", Georgia, USA","冬羽，美国乔治亚州泰碧岛","arb","9/2015","Juvenile, "+gmap("Fort Moultrie",32.75895,-79.85893)+", South Carolina, USA","未成年，美国南卡罗来纳州莫尔特里堡"]);
...
//birds[j++] = new myBird("21-00-00T00:00","LARIDAE ","Black-headed Gull","红嘴鸥","Chroicocephalus ridibundus",[m_id("")],["deinr","12/2020"]);
  birds[j++] = new myBird("21-04-07T12:13","LARIDAE ","Little Gull","小鸥","Hydrocoloeus minutus",[m_id("20210407_039_LittleGull")],["mdmdmd","4/2021",gmap("Cox Point Park",39.29252,-76.46582)+", Baltimore County","Nonbreeding adult","","巴尔的摩郡考克斯角公园"]);
  birds[j++] = new myBird("06-07-16T14:43","LARIDAE ","Laughing Gull","笑鸥","Leucophaeus atricilla",[p_id("0607outerbanks",28),p_id("1505capemay",3),m_id("20161105_112_LaughingGull(WP)")],["ncoutb","7/2006","njcmsp","5/2015","mdocci","11/2016","Winter plumage",""," "+gmap("Inlet",38.32435,-75.08544),"海口"]);
...
//birds[j++] = new myBird("21-00-00T00:00","SPHENISC","African Penguin","非洲企鹅","Spheniscus demersus",[m_id("")],["mdbhrp","9/2015"],"jacpen1");
  birds[j++] = new myBird("16-06-18T09:35","OCEANITI","Wilson's Storm-Petrel","黄蹼洋海燕","Oceanites oceanicus",[m_id("20160618_076_Wilson'sStorm-Petrel")],["arb","6/2016",gmap("Cape May-Lewes Ferry",38.87721,-75.07007)+", Delaware/New Jersey, USA","美国特拉华州/新泽西州五月岬-刘易斯轮渡"],"wispet");
...
//birds[j++] = new myBird("21-00-00T00:00","ACCIPITR","Hen Harrier","白尾鹞","Circus cyaneus",[p_id("1612savannah",4),m_id("20161204_132_NorthernHarrier(I)")],["scsnwr","12/2016","Female","nyjbsp","12/2016","Immature"]);
  ...
  birds[j++] = new myBird("15-09-06T11:23","ACCIPITR","Mississippi Kite","密西西比灰鸢","Ictinia mississippiensis",[m_id("20210613_089_MississippiKite"),p_id("1509charleston",15)],["mdmdmd","6/2021",gmap("Beall Elementary School",39.0882,-77.16267)+", Rockville","","","罗克维尔市比沃小学","arb","9/2015","Juvenile, "+gmap("Patriots Point",32.78888,-79.90322)+", Charleston, South Carolina, USA","未成年，美国南卡罗来纳州查尔斯顿爱国者海角"]);
