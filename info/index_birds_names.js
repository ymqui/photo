<!--
  ...
  var locurl = {arb:["","","",""],
      ...
      cnlydp:  [gmap("Denggao Park",25.09248,117.0358),"Longyan, Fujian, China","龙岩"+bmap("登高山公园",25.099,117.042),"中国福建省"],
      cnlynv:  [gmap("Neiban Village",25.13745,116.9584),"Longyan, Fujian, China","龙岩"+bmap("龙门镇内坂村",25.1433,116.965),"中国福建省"],
