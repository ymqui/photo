...
//    cnxihu:  ["West Lake","Hangzhou, Zhejiang, China","杭州西湖","中国浙江省",wikiurl("West Lake"),baikeurl("西湖")],
      ...
      flplpr:  ["Plantation Preserve","Broward County, Florida, USA","种植园保留地","美国佛罗里达州布劳沃德郡","http://www.plantation.org/Golf/Plantation-Preserve/linear-park.html"],
...
//    gblwcn:  ["London Wetland Centre","United Kingdom","伦敦湿地中心","英国","https://www.wwt.org.uk/wetland-centres/london/"],
      ...
      mdmapp:  ["Mariner Point Park","Harford County, Maryland, USA","水手角公园","美国马里兰州哈福德郡","http://www.harfordcountymd.gov/Facilities/Facility/Details/Mariner-Point-Park-69"],
      ...
      mdsclr:  ["Scotts Landing Road","Worcester County, Maryland, USA","斯科茨码头路","美国马里兰州伍斯特郡","http://www.mdbirds.org/sites/mdsites/shorebirds/shorebirds.html#Worcester"],
      mdswhf:  ["Swan Harbor Farm","Harford County, Maryland, USA","天鹅港农场","美国马里兰州哈福德郡","http://www.harfordcountymd.gov/parks_rec/Parks.cfm?ParkID=65"],
      mdtrlr:  ["Truitts Landing Road","Worcester County, Maryland, USA","特鲁伊特码头路","美国马里兰州伍斯特郡","http://www.mdbirds.org/sites/mdsites/shorebirds/shorebirds.html#Worcester"],
...
//birds[j++] = new myBird("20-00-00T00:00","SCOLOPAC","Buff-breasted Sandpiper","黄胸鹬","Calidris subruficollis",[m_id("")],["mdbhrp","9/2015"]);
  birds[j++] = new myBird("20-10-23T10:02","SCOLOPAC","Pectoral Sandpiper","斑胸滨鹬","Calidris melanotos",[m_id("20201023_109_PectoralSandpiper")],["mdswhf","10/2020","Juvenile"]);
...
//birds[j++] = new myBird("20-00-00T00:00","STRIGIDA","Long-eared Owl","长耳鸮","Asio otus",[m_id("")],["arb","3/2017","Middle Creek Wildlife Management Area, Pennsylvania, USA","美国宾夕法尼亚州中溪野生动物管理区"]);
...
//birds[j++] = new myBird("20-00-00T00:00","FRINGILL","Evening Grosbeak","黄昏锡嘴雀","Coccothraustes vespertinus",[m_id("")],["mdbhrp","11/2020"]);
...
//birds[j++] = new myBird("20-00-00T00:00","FRINGILL","White-winged Crossbill","白翅交嘴雀","Loxia leucoptera",[m_id("")],["caalgp","4/2020"]);
  ...
  birds[j++] = new myBird("15-01-20T08:48","FRINGILL","Pine Siskin","松金翅雀","Spinus pinus",[p_id("1512bhill",7),m_id("20201103_119_PineSiskin")],["mdbhrp","1/2015","On the right (a female "+b_link("Common Redpoll")+" on the left)","右边(左边是一只雌性"+b_link("白腰朱顶雀")+")","mdbhrp","11/2020"]);
