<!--
  ...
  var locurl = {arb:["","","",""],
      ...
      azmcct:  [gmap("Madera Canyon Carrie National Trail",31.7128,-110.8737),"Santa Cruz County, Arizona, USA","马德拉峡谷嘉莉国家山道","美国亚利桑那州圣克鲁斯郡"],
...
//birds[j++] = new myBird("22-00-00T00:00","TROCHILI","Blue-throated Mountain-gem","蓝喉宝石蜂鸟","Lampornis clemenciae",[p_id("2208azbird",7)],["arb","7/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","TROCHILI","Lucifer Hummingbird","瑰丽蜂鸟","Calothorax lucifer",[p_id("2208azbird",7)],["arb","7/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TROCHILI","White-eared Hummingbird","白耳蜂鸟","Basilinna leucotis",[p_id("2208azbird",7)],["arb","7/2015"],"whehum");
...
//birds[j++] = new myBird("22-00-00T00:00","COLUMBID","Ruddy Ground Dove","红地鸠","Columbina talpacoti",[p_id("2208azbird",0)],["mdbhrp","9/2015"],"rugdov");
...
//birds[j++] = new myBird("22-00-00T00:00","PODICIPE","Clark's Grebe","克氏䴙䴘","Aechmophorus clarkii",[p_id("2208azbird",0)],["azazaz",ebird("8/2022",""),gmap("Kennedy Park",32.1806,-111.0074)+", Pima County","","","皮马郡肯尼迪公园"]);
...
//birds[j++] = new myBird("22-00-00T00:00","CATHARTI","California Condor","加州神鹫","Gymnogyps californianus",[p_id("2208azbird")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","ACCIPITR","Zone-tailed Hawk","斑尾鵟","Buteo albonotatus",[p_id("2208azbird",0)],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","STRIGIDA","Elf Owl","娇鸺鹠","Micrathene whitneyi",[p_id("2208azbird",0)],["arb","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","STRIGIDA","Western Screech-Owl","西部鸣角鸮","Megascops kennicottii",[p_id("2208azbird")],["arb","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","STRIGIDA","Spotted Owl","斑林鸮","Strix occidentalis",[p_id("2208azbird",0)],["arb","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PICIDAE ","Gila Woodpecker","吉拉啄木鸟","Melanerpes uropygialis",[p_id("2208azbird",)],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PICIDAE ","Arizona Woodpecker","亚利桑那啄木鸟","Leuconotopicus arizonae",[p_id("2208azbird",)],["cnbjjp","1/2016"],"","");
...
//birds[j++] = new myBird("22-00-00T00:00","PICIDAE ","Gilded Flicker","黄扑翅鴷","Colaptes chrysoides",[p_id("2208azbird",)],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PSITTACU","Rosy-faced Lovebird","桃脸牡丹鹦鹉","Agapornis roseicollis",p_id("2208azbird",[50,48]),["azazaz",ebird("8/2022",""),"Male, "+gmap("Beale Park",35.36253,-119.02511),"","","比尔公园"],"peflov");
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Northern Beardless-Tyrannulet","北无须小霸鹟","Camptostoma imberbe",[p_id("2208azbird",0)],["mdmdmd","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Greater Pewee","大绿霸鹟","Contopus pertinax",[p_id("2208azbird",0)],["mdmdmd","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Cordilleran Flycatcher","科迪纹霸鹟","Empidonax occidentalis",[p_id("2208azbird",0)],["mdmdmd","12/2020","Riverwalk Park, Frederick County","","","弗雷德里克郡河滨公园"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Sulphur-bellied Flycatcher","黄腹大嘴霸鹟","Myiodynastes luteiventris",[p_id("2208azbird",0)],["mdmdmd","12/2020"],"subfly");
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Thick-billed Kingbird","厚嘴王霸鹟","Tyrannus crassirostris",[p_id("2208azbird",0)],["mdmdmd","12/2020"],"thbkin");
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Dusky-capped Flycatcher","暗顶蝇霸鹟","Myiarchus tuberculifer",[p_id("2208azbird",0)],["mdmdmd","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TYRANNID","Brown-crested Flycatcher","褐冠蝇霸鹟","Myiarchus tyrannulus",[p_id("2208azbird",0)],["mdmdmd","12/2020"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TITYRIDA","Rose-throated Becard","红喉厚嘴霸鹟","Pachyramphus aglaiae",[p_id("2208azbird",0)],["mdbhrp","9/2015"],"rotbec");
...
//birds[j++] = new myBird("22-00-00T00:00","VIREONID","Hutton's Vireo","郝氏莺雀","Vireo huttoni",[p_id("2208azbird",13)],["nyjbwr","5/2016","ohmage","5/2017"]);
//birds[j++] = new myBird("22-00-00T00:00","VIREONID","Gray Vireo","灰莺雀","Vireo vicinior",[p_id("2208azbird",13)],["nyjbwr","5/2016","ohmage","5/2017"]);
...
//birds[j++] = new myBird("22-00-00T00:00","CORVIDAE","Mexican Jay","墨西哥丛鸦","Aphelocoma wollweberi",[p_id("2208azbird",)],["mxunam","5/2019"]);
//birds[j++] = new myBird("22-00-00T00:00","CORVIDAE","Woodhouse's Scrub-Jay","伍氏丛鸦","Aphelocoma woodhouseii",[p_id("2208azbird",)],["mxunam","5/2019"],"西丛鸦落基山亚种");
...
//birds[j++] = new myBird("22-00-00T00:00","CORVIDAE","Clark's Nutcracker","北美星鸦","Nucifraga columbiana",[p_id("2208azbird",)],["cnbjjp","1/2016"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PARIDAE ","Bridled Titmouse","白眉冠山雀","Baeolophus wollweberi",[p_id("2208azbird",2)],["caalgp","9/2017"]);
//birds[j++] = new myBird("22-00-00T00:00","PARIDAE ","Juniper Titmouse","林山雀","Baeolophus ridgwayi",[p_id("2208azbird",2)],["caalgp","9/2017"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PARIDAE ","Mountain Chickadee","北美白眉山雀","Poecile gambeli",[p_id("2208azbird",2)],["caalgp","9/2017"],"","");
...
//birds[j++] = new myBird("22-00-00T00:00","HIRUNDIN","Violet-green Swallow","紫绿树燕","Tachycineta thalassina",[p_id("2208azbird")],["nvdnwr","7/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TROGLODY","Cactus Wren","棕曲嘴鹪鹩","Campylorhynchus brunneicapillus",[p_id("2208azbird")],["nvdnwr","7/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","TROGLODY","Rock Wren","岩鹪鹩","Salpinctes obsoletus",[p_id("2208azbird")],["mdocin","10/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","TROGLODY","Canyon Wren","墨西哥鹪鹩","Catherpes mexicanus",[p_id("2208azbird")],["mdocin","10/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","SITTIDAE","Pygmy Nuthatch","小䴓","Sitta pygmaea",[p_id("2208azbird")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","MIMIDAE ","LeConte's Thrasher","勒氏弯嘴嘲鸫","Toxostoma lecontei",[p_id("2208azbird")],["azazaz",ebird("8/2022","")]);
...
//birds[j++] = new myBird("22-00-00T00:00","TURDIDAE","Western Bluebird","西蓝鸲","Sialia mexicana",[p_id("2208azbird")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","TURDIDAE","Varied Thrush","杂色鸫","Ixoreus naevius",[p_id("2208azbird",)],["mdbhrp","9/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","TURDIDAE","Aztec Thrush","阿芝鸫","Ridgwayia pinicola",[p_id("2208azbird",)],["mdbhrp","9/2015"],"aztthr");
...
//birds[j++] = new myBird("22-00-00T00:00","PEUCEDRA","Olive Warbler","橄榄绿森莺","Peucedramus taeniatus",[p_id("2208azbird")],["mdbhrp","9/2015"],"oliwar");
...
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Rufous-winged Sparrow","棕翅珀卡雀鹀","Peucaea carpalis",[p_id("2208azbird",2)],["crarol","4/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Botteri's Sparrow","博氏珀卡雀鹀","Peucaea botterii",[p_id("2208azbird",2)],["crarol","4/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Five-striped Sparrow","五纹漠鹀","Amphispizopsis quinquestriata",[p_id("2208azbird",2)],["crarol","4/2015"],"fisspa");
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Black-throated Sparrow","黑喉漠鹀","Amphispiza bilineata",[p_id("2208azbird",2),["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Black-chinned Sparrow","黑颏雀鹀","Spizella atrogularis",[p_id("2208azbird")],["mxunam","5/2019"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PASSEREL","Yellow-eyed Junco","墨西哥灯草鹀","Junco phaeonotus",[p_id("2208azbird",2),["mdbhrp","9/2015"],"yeejun");
...
//birds[j++] = new myBird("22-00-00T00:00","ICTERIDA","Streak-backed Oriole","红头拟鹂","Icterus pustulatus",[p_id("2208azbird",)],["flflfl","5/2022",gmap("Brewer Park",25.718,-80.2962)+", Miami-Dade County","","","迈阿密-戴德郡布鲁尔公园"],"stbori");
...
//birds[j++] = new myBird("22-00-00T00:00","ICTERIDA","Spot-breasted Oriole","斑胸拟鹂","Icterus pectoralis",[p_id("2204flbird",)],["flflfl","5/2022",gmap("Brewer Park",25.718,-80.2962)+", Miami-Dade County","","","迈阿密-戴德郡布鲁尔公园"]);
...
//birds[j++] = new myBird("22-00-00T00:00","ICTERIDA","Hooded Oriole","巾冠拟鹂","Icterus cucullatus",[p_id("2208azbird")],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PARULIDA","Lucy's Warbler","赤腰虫森莺","Leiothlypis luciae",[p_id("2208azbird",87)],["mdbhrp","9/2015"]);
...
//birds[j++] = new myBird("22-00-00T00:00","PARULIDA","Rufous-capped Warbler","棕顶王森莺","Basileuterus rufifrons",[p_id("2208azbird",87)],["mdbhrp","9/2015"],"rucwar");
...
//birds[j++] = new myBird("22-00-00T00:00","PARULIDA","Red-faced Warbler","红脸森莺","Cardellina rubrifrons",[p_id("2208azbird",87)],["mdbhrp","9/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","PARULIDA","Painted Redstart","彩鸲莺","Myioborus pictus",[p_id("2208azbird",87)],["mdbhrp","9/2015"]);
//birds[j++] = new myBird("22-00-00T00:00","MITROSPI","Dusky-faced Tanager","乌脸唐纳雀","Mitrospingus cassinii",[m_id("")],["mdbhrp","9/2015"],"duftan1");
//birds[j++] = new myBird("22-00-00T00:00","CARDINAL","Hepatic Tanager","暗红丽唐纳雀","Piranga hepatica",[p_id("2208azbird",87)],["crarol","12/2018","Male"]);
