...
function initAlbum(){
    ...
    if(window.usechinese){
        this[1][0] = "球球和妈妈在黑水瀑布山道上的“几乎是天堂”秋千上荡秋千。";
        this[1][1] = "在黑水瀑布。";
        this[1][2] = "球球在大石头上做劈叉。";
        ...
        this[1][0] = "Nathan and Mom swinging on the Almost Heaven swing on the Blackwater Falls Trail.";
        this[1][1] = "At the Blackwater Falls.";
        this[1][2] = "Nathan doing a split on the giant boulder.";
        ...
        this[1][10] = "Nathan showing off his gymnastics skill.";
