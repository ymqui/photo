...
function initAlbum(){
    ...
    if(window.usechinese){
        ...
        this[1][51] = "橙翅亚马逊鹦鹉，迈阿密-戴德郡马西森硬木公园。";
        this[1][52] = "东美角鸮，灰色形，迈阿密-戴德郡马西森硬木公园。";
        this[1][53] = "东美角鸮，灰色形，迈阿密-戴德郡马西森硬木公园。";
        this[1][54] = "短尾鵟，未成年黑色形，迈阿密-戴德郡马西森硬木公园。";
        ...
        this[1][41] = "Wilson's Plover, female, Carlos Pointe, Fort Myers Beach.";
        this[1][42] = "Wilson's Plover, male, Carlos Pointe, Fort Myers Beach.";
        this[1][43] = "Common Ground Dove, Carlos Pointe, Fort Myers Beach.";
        this[1][44] = "Roseate Spoonbill, Carlos Pointe, Fort Myers Beach.";
        this[1][45] = "Willet, Carlos Pointe, Fort Myers Beach.";
        this[1][46] = "Killdeer, immature, Carlos Pointe, Fort Myers Beach.";
        this[1][47] = "Orange-winged Parrot, Brewer Park, Miami-Dade County.";
        this[1][48] = "Red-crowned Parrot, Brewer Park, Miami-Dade County.";
        this[1][49] = "Chestnut-fronted Macaw, Brewer Park, Miami-Dade County.";
        this[1][50] = "Yellow-chevroned Parakeet, Fuchs Park, Miami-Dade County.";
        this[1][51] = "Orange-winged Parrot, Matheson Hammock Park, Miami-Dade County.";
        this[1][52] = "Eastern Screech-Owl, gray morph, Matheson Hammock Park, Miami-Dade County.";
        this[1][53] = "Eastern Screech-Owl, gray morph, Matheson Hammock Park, Miami-Dade County.";
        this[1][54] = "Shrot-tailed Hawk, immature dark morph, Matheson Hammock Park, Miami-Dade County.";
